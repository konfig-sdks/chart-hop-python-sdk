...
class CreateForm(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["label", "fields", "blocks", "status", "description", "type", "targetType", "targetFilter", "submitFilter", "responseReadFilter", "useFieldAccess", "approval", "authorSensitive", "options", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["label", "fields", "blocks", "status", "description", "type", "targetType", "targetFilter", "submitFilter", "responseReadFilter", "useFieldAccess", "approval", "authorSensitive", "options", ], str]):
