...
class BaseApi(api_client.Api):
    ...
    def _update_position_details_mapped_args(
        self,
        org_id: str,
        position_id: str,
    ...
    async def _aupdate_position_details_oapg(
        self,
    ...
    def _update_position_details_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdatePositionDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_position_details(
        self,
        org_id: str,
        position_id: str,
        scenario_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_position_details_mapped_args(
            org_id=org_id,
            position_id=position_id,
            scenario_id=scenario_id,
            date=date,
        )
        return await self._aupdate_position_details_oapg(
            body=args.body,
    ...
    def update_position_details(
        ...
        return self._update_position_details_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdatePositionDetails(BaseApi):
    ...
    async def aupdate_position_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_position_details(
            org_id=org_id,
            position_id=position_id,
            scenario_id=scenario_id,
            date=date,
    ...
    def update_position_details(
        ...
        raw_response = self.raw.update_position_details(
            org_id=org_id,
            position_id=position_id,
            scenario_id=scenario_id,
            date=date,
