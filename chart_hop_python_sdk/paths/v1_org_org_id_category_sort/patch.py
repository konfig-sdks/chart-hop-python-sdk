...
class BaseApi(api_client.Api):
    ...
    def _update_existing_category_sort_mapped_args(
        self,
        org_id: str,
    ...
    async def _aupdate_existing_category_sort_oapg(
        self,
    ...
    def _update_existing_category_sort_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateExistingCategorySortRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_existing_category_sort(
        self,
        org_id: str,
        category_ids: typing.Optional[UpdateCategorySortCategoryIds] = None,
        **kwargs,
        ...
        args = self._update_existing_category_sort_mapped_args(
            org_id=org_id,
            category_ids=category_ids,
        )
        return await self._aupdate_existing_category_sort_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_existing_category_sort(
        self,
        org_id: str,
        category_ids: typing.Optional[UpdateCategorySortCategoryIds] = None,
    ) -> typing.Union[
        ...
        return self._update_existing_category_sort_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateExistingCategorySort(BaseApi):
    ...
    async def aupdate_existing_category_sort(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_existing_category_sort(
            org_id=org_id,
            category_ids=category_ids,
            **kwargs,
        )
    ...
    def update_existing_category_sort(
        ...
        raw_response = self.raw.update_existing_category_sort(
            org_id=org_id,
            category_ids=category_ids,
        )
