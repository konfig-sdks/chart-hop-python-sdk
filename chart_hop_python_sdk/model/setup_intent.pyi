...
class SetupIntent(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["clientSecret", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["clientSecret", ], str]):
