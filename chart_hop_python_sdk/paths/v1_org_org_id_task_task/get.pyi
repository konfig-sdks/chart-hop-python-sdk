...
ReturnFormCompletionLinksSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'returnFormCompletionLinks': typing.Union[ReturnFormCompletionLinksSchema, bool, ],
    },
    total=False
)
...
request_query_return_form_completion_links = api_client.QueryParameter(
    name="returnFormCompletionLinks",
    style=api_client.ParameterStyle.FORM,
    schema=ReturnFormCompletionLinksSchema,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    ...
    def _query_assessment_tasks_mapped_args(
        self,
        org_id: str,
        ...
        return_form_completion_links: typing.Optional[bool] = None,
        ...
        if return_form_completion_links is not None:
            _query_params["returnFormCompletionLinks"] = return_form_completion_links
    ...
    async def _aquery_assessment_tasks_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_return_form_completion_links,
        ):
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/task/task',
            headers=_headers,
        )
    ...
    def _query_assessment_tasks_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class QueryAssessmentTasksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_assessment_tasks(
        self,
        org_id: str,
        user_id: typing.Optional[str] = None,
        assessment_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._query_assessment_tasks_mapped_args(
            org_id=org_id,
            user_id=user_id,
            ...
            return_form_completion_links=return_form_completion_links,
        )
        return await self._aquery_assessment_tasks_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def query_assessment_tasks(
        self,
        org_id: str,
        user_id: typing.Optional[str] = None,
        assessment_id: typing.Optional[str] = None,
        ...
        return self._query_assessment_tasks_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class QueryAssessmentTasks(BaseApi):
    ...
    async def aquery_assessment_tasks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_assessment_tasks(
            org_id=org_id,
            user_id=user_id,
            assessment_id=assessment_id,
            status=status,
    ...
    def query_assessment_tasks(
        ...
        raw_response = self.raw.query_assessment_tasks(
            org_id=org_id,
            user_id=user_id,
            assessment_id=assessment_id,
            status=status,
