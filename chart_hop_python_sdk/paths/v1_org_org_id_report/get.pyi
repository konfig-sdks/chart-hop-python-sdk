...
from chart_hop_python_sdk.model.report_data_stream_results import ReportDataStreamResults as ReportDataStreamResultsSchema

from chart_hop_python_sdk.type.report_data_stream_results import ReportDataStreamResults

from ...api_client import Dictionary
from chart_hop_python_sdk.pydantic.report_data_stream_results import ReportDataStreamResults as ReportDataStreamResultsPydantic

# Query params
FromIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fromId': typing.Union[FromIdSchema, str, ],
...
request_query_from_id = api_client.QueryParameter(
    name="fromId",
...
SchemaFor200ResponseBodyApplicationJson = ReportDataStreamResultsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ReportDataStreamResults
...
class GetAllPaginated(BaseApi):
    ...
    async def aget_all_paginated(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReportDataStreamResultsPydantic:
        ...
        if validate:
            return ReportDataStreamResultsPydantic(**raw_response.body)
        return api_client.construct_model_instance(ReportDataStreamResultsPydantic, raw_response.body)
