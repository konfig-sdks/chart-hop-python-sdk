...
class BaseApi(api_client.Api):
    ...
    def _expire_form_tasks_mapped_args(
        self,
        org_id: str,
        assessment_id: str,
        form_id: str,
    ...
    async def _aexpire_form_tasks_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/assessment/{assessmentId}/form/{formId}/expire',
            headers=_headers,
        )
...
class ExpireFormTasksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aexpire_form_tasks(
        self,
        org_id: str,
        assessment_id: str,
        form_id: str,
        **kwargs,
        ...
        args = self._expire_form_tasks_mapped_args(
            org_id=org_id,
            assessment_id=assessment_id,
            form_id=form_id,
        )
        return await self._aexpire_form_tasks_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def expire_form_tasks(
        self,
        org_id: str,
        assessment_id: str,
        form_id: str,
        ...
        return self._expire_form_tasks_oapg(
            path_params=args.path,
        )

class ExpireFormTasks(BaseApi):
    ...
    async def aexpire_form_tasks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aexpire_form_tasks(
            org_id=org_id,
            assessment_id=assessment_id,
            form_id=form_id,
            **kwargs,
    ...
    def expire_form_tasks(
        ...
        raw_response = self.raw.expire_form_tasks(
            org_id=org_id,
            assessment_id=assessment_id,
            form_id=form_id,
        )
