...
class BaseApi(api_client.Api):
    ...
    def _reject_time_off_request_mapped_args(
        self,
        org_id: str,
        time_off_id: str,
    ...
    async def _areject_time_off_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/timeoff/{timeOffId}/reject',
            body=body,
            headers=_headers,
        )
    ...
    def _reject_time_off_request_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RejectTimeOffRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areject_time_off_request(
        self,
        org_id: str,
        time_off_id: str,
        message: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._reject_time_off_request_mapped_args(
            org_id=org_id,
            time_off_id=time_off_id,
            message=message,
        )
        return await self._areject_time_off_request_oapg(
            body=args.body,
    ...
    def reject_time_off_request(
        ...
        return self._reject_time_off_request_oapg(
            body=args.body,
            path_params=args.path,
        )

class RejectTimeOffRequest(BaseApi):
    ...
    async def areject_time_off_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areject_time_off_request(
            org_id=org_id,
            time_off_id=time_off_id,
            message=message,
            **kwargs,
    ...
    def reject_time_off_request(
        ...
        raw_response = self.raw.reject_time_off_request(
            org_id=org_id,
            time_off_id=time_off_id,
            message=message,
        )
