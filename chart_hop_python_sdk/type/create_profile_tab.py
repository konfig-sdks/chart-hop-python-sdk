...
class RequiredCreateProfileTab(TypedDict):
...
class OptionalCreateProfileTab(TypedDict, total=False):
...
class CreateProfileTab(RequiredCreateProfileTab, OptionalCreateProfileTab):
    pass
