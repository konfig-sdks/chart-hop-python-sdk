...
class BaseApi(api_client.Api):
    ...
    def _delete_chain_by_id_mapped_args(
        self,
        org_id: str,
    ...
    async def _adelete_chain_by_id_oapg(
        self,
...
class DeleteChainByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_chain_by_id(
        self,
        org_id: str,
        approval_chain_id: str,
        **kwargs,
        ...
        args = self._delete_chain_by_id_mapped_args(
            org_id=org_id,
            approval_chain_id=approval_chain_id,
        )
        return await self._adelete_chain_by_id_oapg(
    ...
    def delete_chain_by_id(
        ...
        return self._delete_chain_by_id_oapg(
            path_params=args.path,
        )

class DeleteChainById(BaseApi):
    ...
    async def adelete_chain_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_chain_by_id(
            org_id=org_id,
            approval_chain_id=approval_chain_id,
            **kwargs,
        )
    ...
    def delete_chain_by_id(
        ...
        raw_response = self.raw.delete_chain_by_id(
            org_id=org_id,
            approval_chain_id=approval_chain_id,
        )
