...
# Query params
FilterScenarioIdsSchema = schemas.StrSchema
IneligibleSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'filterScenarioIds': typing.Union[FilterScenarioIdsSchema, str, ],
        'ineligible': typing.Union[IneligibleSchema, bool, ],
...
request_query_filter_scenario_ids = api_client.QueryParameter(
    name="filterScenarioIds",
    style=api_client.ParameterStyle.FORM,
    schema=FilterScenarioIdsSchema,
    explode=True,
)
request_query_ineligible = api_client.QueryParameter(
    name="ineligible",
    style=api_client.ParameterStyle.FORM,
    schema=IneligibleSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_eligible_employees_mapped_args(
        self,
        org_id: str,
        comp_review_id: str,
        filter_scenario_ids: typing.Optional[str] = None,
        ineligible: typing.Optional[bool] = None,
        ...
        _query_params = {}
        _path_params = {}
        if filter_scenario_ids is not None:
            _query_params["filterScenarioIds"] = filter_scenario_ids
        if ineligible is not None:
            _query_params["ineligible"] = ineligible
    ...
    async def _aget_eligible_employees_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_filter_scenario_ids,
            request_query_ineligible,
            request_query__from,
            request_query_limit,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/comp-review/{compReviewId}/eligible-employees',
            headers=_headers,
        )
    ...
    def _get_eligible_employees_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetEligibleEmployeesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_eligible_employees(
        self,
        org_id: str,
        comp_review_id: str,
        filter_scenario_ids: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_eligible_employees_mapped_args(
            org_id=org_id,
        ...
        return await self._aget_eligible_employees_oapg(
    ...
    def get_eligible_employees(
        ...
        return self._get_eligible_employees_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetEligibleEmployees(BaseApi):
    ...
    async def aget_eligible_employees(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_eligible_employees(
            org_id=org_id,
            comp_review_id=comp_review_id,
            filter_scenario_ids=filter_scenario_ids,
            ineligible=ineligible,
    ...
    def get_eligible_employees(
        ...
        raw_response = self.raw.get_eligible_employees(
            org_id=org_id,
            comp_review_id=comp_review_id,
            filter_scenario_ids=filter_scenario_ids,
            ineligible=ineligible,
