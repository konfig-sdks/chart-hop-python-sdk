...
class BaseApi(api_client.Api):
    ...
    def _get_all_configs_mapped_args(
        self,
        org_id: str,
    ...
    async def _aget_all_configs_oapg(
        self,
...
class GetAllConfigsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_configs(
        self,
        org_id: str,
        _from: typing.Optional[str] = None,
        parent_entity_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_configs_mapped_args(
            org_id=org_id,
            _from=_from,
        ...
        return await self._aget_all_configs_oapg(
...
class GetAllConfigs(BaseApi):
    ...
    async def aget_all_configs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_configs(
            org_id=org_id,
            _from=_from,
            parent_entity_id=parent_entity_id,
            assessment_id=assessment_id,
    ...
    def get_all_configs(
        ...
        raw_response = self.raw.get_all_configs(
            org_id=org_id,
            _from=_from,
            parent_entity_id=parent_entity_id,
            assessment_id=assessment_id,
