...
from chart_hop_python_sdk.model.create_budget_pool import CreateBudgetPool as CreateBudgetPoolSchema
...
from chart_hop_python_sdk.model.create_budget_pool_fixed_budget_map import CreateBudgetPoolFixedBudgetMap as CreateBudgetPoolFixedBudgetMapSchema

from chart_hop_python_sdk.type.money import Money
from chart_hop_python_sdk.type.create_budget_pool import CreateBudgetPool
...
from chart_hop_python_sdk.pydantic.create_budget_pool import CreateBudgetPool as CreateBudgetPoolPydantic
from chart_hop_python_sdk.pydantic.create_budget_pool_fixed_budget_map import CreateBudgetPoolFixedBudgetMap as CreateBudgetPoolFixedBudgetMapPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateBudgetPoolSchema


request_body_create_budget_pool = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_pool_mapped_args(
        self,
        comp_review_id: str,
        label: str,
        applied_field: str,
        ...
        fixed_budget_map: typing.Optional[CreateBudgetPoolFixedBudgetMap] = None,
    ...
    async def _acreate_new_pool_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/budget-pool',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_create_budget_pool.serialize(body, content_type)
...
class CreateNewPoolRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_pool(
        self,
        comp_review_id: str,
        label: str,
        applied_field: str,
        ...
        **kwargs,
        ...
        args = self._create_new_pool_mapped_args(
        ...
        return await self._acreate_new_pool_oapg(
            body=args.body,
    ...
    def create_new_pool(
        ...
        return self._create_new_pool_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewPool(BaseApi):
    ...
    async def acreate_new_pool(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_pool(
            comp_review_id=comp_review_id,
            label=label,
            applied_field=applied_field,
            source_field=source_field,
    ...
    def create_new_pool(
        ...
        raw_response = self.raw.create_new_pool(
            comp_review_id=comp_review_id,
            label=label,
            applied_field=applied_field,
            source_field=source_field,
