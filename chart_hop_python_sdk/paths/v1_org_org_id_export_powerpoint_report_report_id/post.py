...
class BaseApi(api_client.Api):
    ...
    def _report_to_powerpoint_mapped_args(
        self,
        org_id: str,
        report_id: str,
    ...
    async def _areport_to_powerpoint_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/export/powerpoint/report/{reportId}',
            body=body,
            headers=_headers,
        )
    ...
    def _report_to_powerpoint_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ReportToPowerpointRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areport_to_powerpoint(
        self,
        org_id: str,
        report_id: str,
        **kwargs,
        ...
        args = self._report_to_powerpoint_mapped_args(
            org_id=org_id,
            report_id=report_id,
        )
        return await self._areport_to_powerpoint_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def report_to_powerpoint(
        self,
        org_id: str,
        report_id: str,
    ) -> typing.Union[
        ...
        return self._report_to_powerpoint_oapg(
            body=args.body,
            path_params=args.path,
        )

class ReportToPowerpoint(BaseApi):
    ...
    async def areport_to_powerpoint(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areport_to_powerpoint(
            org_id=org_id,
            report_id=report_id,
            **kwargs,
        )
    ...
    def report_to_powerpoint(
        ...
        raw_response = self.raw.report_to_powerpoint(
            org_id=org_id,
            report_id=report_id,
        )
        if validate:
