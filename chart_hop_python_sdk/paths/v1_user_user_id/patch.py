...
class BaseApi(api_client.Api):
    ...
    def _update_existing_user_mapped_args(
        self,
        user_id: str,
    ...
    async def _aupdate_existing_user_oapg(
        self,
    ...
    def _update_existing_user_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateExistingUserRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_existing_user(
        self,
        user_id: str,
        app_id: typing.Optional[str] = None,
        name: typing.Optional[Name] = None,
        ...
        **kwargs,
        ...
        args = self._update_existing_user_mapped_args(
            user_id=user_id,
            app_id=app_id,
            name=name,
            email=email,
        ...
        return await self._aupdate_existing_user_oapg(
            body=args.body,
    ...
    def update_existing_user(
        ...
        return self._update_existing_user_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateExistingUser(BaseApi):
    ...
    async def aupdate_existing_user(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_existing_user(
            user_id=user_id,
            app_id=app_id,
            name=name,
            email=email,
    ...
    def update_existing_user(
        ...
        raw_response = self.raw.update_existing_user(
            user_id=user_id,
            app_id=app_id,
            name=name,
            email=email,
