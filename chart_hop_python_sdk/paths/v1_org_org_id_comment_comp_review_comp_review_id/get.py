...
class BaseApi(api_client.Api):
    ...
    def _list_comments_on_comp_review_mapped_args(
        self,
        org_id: str,
        comp_review_id: str,
    ...
    async def _alist_comments_on_comp_review_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/comment/comp-review/{compReviewId}',
            headers=_headers,
        )
    ...
    def _list_comments_on_comp_review_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListCommentsOnCompReviewRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_comments_on_comp_review(
        self,
        org_id: str,
        comp_review_id: str,
        approval_request_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_comments_on_comp_review_mapped_args(
            org_id=org_id,
        ...
        return await self._alist_comments_on_comp_review_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def list_comments_on_comp_review(
        self,
        org_id: str,
        comp_review_id: str,
        approval_request_id: typing.Optional[str] = None,
        ...
        return self._list_comments_on_comp_review_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListCommentsOnCompReview(BaseApi):
    ...
    async def alist_comments_on_comp_review(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_comments_on_comp_review(
            org_id=org_id,
            comp_review_id=comp_review_id,
            approval_request_id=approval_request_id,
            _from=_from,
    ...
    def list_comments_on_comp_review(
        ...
        raw_response = self.raw.list_comments_on_comp_review(
            org_id=org_id,
            comp_review_id=comp_review_id,
            approval_request_id=approval_request_id,
            _from=_from,
