...
class BaseApi(api_client.Api):
    ...
    def _get_by_entity_id_mapped_args(
        self,
        org_id: str,
        entity_id: str,
    ...
    async def _aget_by_entity_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/comment/entity/{entityId}',
            headers=_headers,
        )
...
class GetByEntityIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_entity_id(
        self,
        org_id: str,
        entity_id: str,
        _from: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_by_entity_id_mapped_args(
            org_id=org_id,
            entity_id=entity_id,
            _from=_from,
            limit=limit,
        ...
        return await self._aget_by_entity_id_oapg(
    ...
    def get_by_entity_id(
        ...
        return self._get_by_entity_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByEntityId(BaseApi):
    ...
    async def aget_by_entity_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_entity_id(
            org_id=org_id,
            entity_id=entity_id,
            _from=_from,
            limit=limit,
    ...
    def get_by_entity_id(
        ...
        raw_response = self.raw.get_by_entity_id(
            org_id=org_id,
            entity_id=entity_id,
            _from=_from,
            limit=limit,
