...
class BaseApi(api_client.Api):
    ...
    def _csv_data_column_match_mapped_args(
        self,
        org_id: str,
    ...
    async def _acsv_data_column_match_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/import/csv/initialColumnMatch',
            body=body,
            headers=_headers,
        )
    ...
    def _csv_data_column_match_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CsvDataColumnMatchRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acsv_data_column_match(
        self,
        org_id: str,
        file: typing.Optional[typing.IO] = None,
        **kwargs,
        ...
        args = self._csv_data_column_match_mapped_args(
            org_id=org_id,
            file=file,
        )
        return await self._acsv_data_column_match_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def csv_data_column_match(
        self,
        org_id: str,
        file: typing.Optional[typing.IO] = None,
    ) -> typing.Union[
        ...
        return self._csv_data_column_match_oapg(
            body=args.body,
            path_params=args.path,
        )

class CsvDataColumnMatch(BaseApi):
    ...
    async def acsv_data_column_match(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acsv_data_column_match(
            org_id=org_id,
            file=file,
            **kwargs,
        )
    ...
    def csv_data_column_match(
        ...
        raw_response = self.raw.csv_data_column_match(
            org_id=org_id,
            file=file,
        )
