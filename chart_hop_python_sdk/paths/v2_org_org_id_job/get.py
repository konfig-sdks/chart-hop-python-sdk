...
request_query_approval_chain_id = api_client.QueryParameter(
...
class BaseApi(api_client.Api):
    ...
    def _find_in_organization_0_mapped_args(
        self,
        org_id: str,
        scenario_id: typing.Optional[str] = None,
        comp_review_id: typing.Optional[str] = None,
        approval_chain_id: typing.Optional[str] = None,
        ...
        if approval_chain_id is not None:
            _query_params["approvalChainId"] = approval_chain_id
        if date is not None:
    ...
    async def _afind_in_organization_0_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_query_approval_chain_id,
            request_query_date,
            request_query_q,
            request_query__from,
            request_query_limit,
        ...
        request_before_hook(
            ...
            path_template='/v2/org/{orgId}/job',
            headers=_headers,
        )
    ...
    def _find_in_organization_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class FindInOrganization0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afind_in_organization_0(
        self,
        org_id: str,
        scenario_id: typing.Optional[str] = None,
        comp_review_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._find_in_organization_0_mapped_args(
            org_id=org_id,
        ...
        return await self._afind_in_organization_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def find_in_organization_0(
        self,
        org_id: str,
        scenario_id: typing.Optional[str] = None,
        comp_review_id: typing.Optional[str] = None,
        ...
        return self._find_in_organization_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class FindInOrganization0(BaseApi):
    ...
    async def afind_in_organization_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afind_in_organization_0(
            org_id=org_id,
            scenario_id=scenario_id,
            comp_review_id=comp_review_id,
            approval_chain_id=approval_chain_id,
    ...
    def find_in_organization_0(
        ...
        raw_response = self.raw.find_in_organization_0(
            org_id=org_id,
            scenario_id=scenario_id,
            comp_review_id=comp_review_id,
            approval_chain_id=approval_chain_id,
