...
class RequiredPartialMessage(TypedDict):
    pass

class OptionalPartialMessage(TypedDict, total=False):
    # message title
    title: str
...
class PartialMessage(RequiredPartialMessage, OptionalPartialMessage):
    pass
