...
class BaseApi(api_client.Api):
    ...
    def _export_comments_mapped_args(
        self,
        org_id: str,
        comp_review_id: str,
    ...
    async def _aexport_comments_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/comp-review/{compReviewId}/export/comments',
            headers=_headers,
        )
...
class ExportCommentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aexport_comments(
        self,
        org_id: str,
        comp_review_id: str,
        **kwargs,
        ...
        args = self._export_comments_mapped_args(
            org_id=org_id,
            comp_review_id=comp_review_id,
        )
        return await self._aexport_comments_oapg(
    ...
    def export_comments(
        ...
        return self._export_comments_oapg(
            path_params=args.path,
        )

class ExportComments(BaseApi):
    ...
    async def aexport_comments(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aexport_comments(
            org_id=org_id,
            comp_review_id=comp_review_id,
            **kwargs,
        )
    ...
    def export_comments(
        ...
        raw_response = self.raw.export_comments(
            org_id=org_id,
            comp_review_id=comp_review_id,
        )
        if validate:
