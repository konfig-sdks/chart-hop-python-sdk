...
from chart_hop_python_sdk.model.create_policy import CreatePolicy as CreatePolicySchema
...
from chart_hop_python_sdk.type.create_policy import CreatePolicy
...
from chart_hop_python_sdk.pydantic.create_policy import CreatePolicy as CreatePolicyPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreatePolicySchema


request_body_create_policy = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = PolicySchema
    ...
    async def _acreate_new_policy_oapg(
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_policy.serialize(body, content_type)
