...
class UpdateCompReview(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["label", "config", "status", "shareAccess", "reviewerCount", "submittedCount", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["label", "config", "status", "shareAccess", "reviewerCount", "submittedCount", ], str]):
