...
class RequiredUpdateAssessment(TypedDict):
    pass

class OptionalUpdateAssessment(TypedDict, total=False):
...
class UpdateAssessment(RequiredUpdateAssessment, OptionalUpdateAssessment):
    pass
