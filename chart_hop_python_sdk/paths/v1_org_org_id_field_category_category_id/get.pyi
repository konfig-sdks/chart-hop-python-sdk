...
class BaseApi(api_client.Api):
    ...
    def _get_fields_in_category_mapped_args(
        self,
        org_id: str,
        category_id: str,
    ...
    async def _aget_fields_in_category_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/field/category/{categoryId}',
            headers=_headers,
        )
    ...
    def _get_fields_in_category_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetFieldsInCategoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_fields_in_category(
        self,
        org_id: str,
        category_id: str,
        **kwargs,
        ...
        args = self._get_fields_in_category_mapped_args(
            org_id=org_id,
            category_id=category_id,
        )
        return await self._aget_fields_in_category_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_fields_in_category(
        self,
        org_id: str,
        category_id: str,
    ) -> typing.Union[
        ...
        return self._get_fields_in_category_oapg(
            path_params=args.path,
        )

class GetFieldsInCategory(BaseApi):
    ...
    async def aget_fields_in_category(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_fields_in_category(
            org_id=org_id,
            category_id=category_id,
            **kwargs,
        )
    ...
    def get_fields_in_category(
        ...
        raw_response = self.raw.get_fields_in_category(
            org_id=org_id,
            category_id=category_id,
        )
        if validate:
