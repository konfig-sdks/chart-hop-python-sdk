...
class PartialReportChart(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "orgId", "reportId", "label", "type", "filter", "filterOverride", "query", "sort", "isAdvancedQueryMode", "createId", "createAt", "updateId", "updateAt", "deleteId", "deleteAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "orgId", "reportId", "label", "type", "filter", "filterOverride", "query", "sort", "isAdvancedQueryMode", "createId", "createAt", "updateId", "updateAt", "deleteId", "deleteAt", ], str]):
