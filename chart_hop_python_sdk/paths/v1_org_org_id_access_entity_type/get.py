...
from chart_hop_python_sdk.model.access_response import AccessResponse as AccessResponseSchema

from chart_hop_python_sdk.type.access_response import AccessResponse

from ...api_client import Dictionary
from chart_hop_python_sdk.pydantic.access_response import AccessResponse as AccessResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AccessResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _entity_actions_mapped_args(
        self,
        org_id: str,
        type: str,
    ...
    async def _aentity_actions_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/access/entity/{type}',
            headers=_headers,
        )
...
class EntityActionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aentity_actions(
        self,
        org_id: str,
        type: str,
        id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._entity_actions_mapped_args(
            org_id=org_id,
            type=type,
            id=id,
            action=action,
        ...
        return await self._aentity_actions_oapg(
    ...
    def entity_actions(
        ...
        return self._entity_actions_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class EntityActions(BaseApi):
    ...
    async def aentity_actions(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AccessResponsePydantic:
        raw_response = await self.raw.aentity_actions(
            org_id=org_id,
            type=type,
            id=id,
            action=action,
        ...
        if validate:
            return AccessResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AccessResponsePydantic, raw_response.body)
    ...
    def entity_actions(
        ...
        raw_response = self.raw.entity_actions(
            org_id=org_id,
            type=type,
            id=id,
            action=action,
