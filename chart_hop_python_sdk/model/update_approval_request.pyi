...
class UpdateApprovalRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["stageOverrides", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["stageOverrides"]) -> typing.Union[MetaOapg.properties.stageOverrides, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["stageOverrides", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        stageOverrides: typing.Union[MetaOapg.properties.stageOverrides, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
