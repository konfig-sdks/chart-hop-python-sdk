...
class RequiredBudgetAllocation(TypedDict):
    pass

class OptionalBudgetAllocation(TypedDict, total=False):
...
class BudgetAllocation(RequiredBudgetAllocation, OptionalBudgetAllocation):
    pass
