...
class PartialMessage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "id", "orgId", "type", "notificationType", "userId", "content", "messageUrl", "key", "readAt", "seenAt", "createId", "createAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "id", "orgId", "type", "notificationType", "userId", "content", "messageUrl", "key", "readAt", "seenAt", "createId", "createAt", ], str]):
