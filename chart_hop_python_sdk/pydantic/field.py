...
from chart_hop_python_sdk.pydantic.field_aliases import FieldAliases
from chart_hop_python_sdk.pydantic.field_category_ids import FieldCategoryIds
from chart_hop_python_sdk.pydantic.field_override_revert import FieldOverrideRevert
...
class Field(BaseModel):
    ...
    plural: Literal["SINGLE", "LIST", "SET"] = Field(alias='plural')
    ...
    entity_type: typing.Optional[Literal["JOB", "JOB_OPEN", "JOB_FILLED", "PERSON", "CHANGE", "TABLE", "ORG", "USER", "NONE"]] = Field(None, alias='entityType')
    ...
    aliases: typing.Optional[FieldAliases] = Field(None, alias='aliases')
    ...
    category_ids: typing.Optional[FieldCategoryIds] = Field(None, alias='categoryIds')
    ...
    readonly: typing.Optional[bool] = Field(None, alias='readonly')

    built_in: typing.Optional[bool] = Field(None, alias='builtIn')

    can_override_sensitivity: typing.Optional[bool] = Field(None, alias='canOverrideSensitivity')

    # number of decimal places for money values
    places: typing.Optional[int] = Field(None, alias='places')

    override_revert: typing.Optional[FieldOverrideRevert] = Field(None, alias='overrideRevert')

    override_name: typing.Optional[str] = Field(None, alias='overrideName')

    has_subfields: typing.Optional[bool] = Field(None, alias='hasSubfields')
