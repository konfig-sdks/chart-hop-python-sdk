...
# Query params
EvalJobIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'evalJobId': typing.Union[EvalJobIdSchema, str, ],
    },
    total=False
)
...
request_query_eval_job_id = api_client.QueryParameter(
    name="evalJobId",
    style=api_client.ParameterStyle.FORM,
    schema=EvalJobIdSchema,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    ...
    def _get_by_id_mapped_args(
        ...
        org_id: str,
        form_id: str,
        eval_job_id: typing.Optional[str] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        _path_params = {}
        if eval_job_id is not None:
            _query_params["evalJobId"] = eval_job_id
