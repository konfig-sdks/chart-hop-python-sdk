...
class BaseApi(api_client.Api):
    ...
    def _mark_messages_as_read_mapped_args(
        self,
        org_id: str,
    ...
    async def _amark_messages_as_read_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/message/bulk/read',
            body=body,
            headers=_headers,
        )
    ...
    def _mark_messages_as_read_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class MarkMessagesAsReadRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def amark_messages_as_read(
        self,
        org_id: str,
        body: typing.Optional[MessageMarkMessagesAsReadRequest] = None,
        **kwargs,
        ...
        args = self._mark_messages_as_read_mapped_args(
            body=body,
            org_id=org_id,
        )
        return await self._amark_messages_as_read_oapg(
            body=args.body,
    ...
    def mark_messages_as_read(
        ...
        return self._mark_messages_as_read_oapg(
            body=args.body,
            path_params=args.path,
        )

class MarkMessagesAsRead(BaseApi):
    ...
    async def amark_messages_as_read(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.amark_messages_as_read(
            body=body,
            org_id=org_id,
            **kwargs,
        )
    ...
    def mark_messages_as_read(
        ...
        raw_response = self.raw.mark_messages_as_read(
            body=body,
            org_id=org_id,
        )
