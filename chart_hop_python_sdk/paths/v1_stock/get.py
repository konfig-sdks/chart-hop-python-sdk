...
from chart_hop_python_sdk.model.results_stock_price import ResultsStockPrice as ResultsStockPriceSchema

from chart_hop_python_sdk.type.results_stock_price import ResultsStockPrice

from ...api_client import Dictionary
from chart_hop_python_sdk.pydantic.results_stock_price import ResultsStockPrice as ResultsStockPricePydantic
...
SchemaFor200ResponseBodyApplicationJson = ResultsStockPriceSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ResultsStockPrice
...
class GetHistory(BaseApi):
    ...
    async def aget_history(
        ...
        **kwargs,
        ...
        if validate:
            return ResultsStockPricePydantic(**raw_response.body)
        return api_client.construct_model_instance(ResultsStockPricePydantic, raw_response.body)
