...
class BaseApi(api_client.Api):
    ...
    def _install_app_for_org_mapped_args(
        self,
    ...
    async def _ainstall_app_for_org_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/app/org/{orgId}/install',
            body=body,
            headers=_headers,
        )
...
class InstallAppForOrgRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainstall_app_for_org(
        self,
        orgs: typing.List[OrgAccess],
        org_id: str,
        app_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._install_app_for_org_mapped_args(
            orgs=orgs,
            org_id=org_id,
            app_id=app_id,
            name=name,
        ...
        return await self._ainstall_app_for_org_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def install_app_for_org(
        self,
        orgs: typing.List[OrgAccess],
        org_id: str,
        app_id: typing.Optional[str] = None,
        ...
        return self._install_app_for_org_oapg(
            body=args.body,
            path_params=args.path,
        )

class InstallAppForOrg(BaseApi):
    ...
    async def ainstall_app_for_org(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainstall_app_for_org(
            orgs=orgs,
            org_id=org_id,
            app_id=app_id,
            name=name,
    ...
    def install_app_for_org(
        ...
        raw_response = self.raw.install_app_for_org(
            orgs=orgs,
            org_id=org_id,
            app_id=app_id,
            name=name,
