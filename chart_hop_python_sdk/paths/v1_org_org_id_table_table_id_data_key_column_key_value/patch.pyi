...
class BaseApi(api_client.Api):
    ...
    def _update_existing_row_data_mapped_args(
        self,
        org_id: str,
        table_id: str,
        key_column: str,
    ...
    async def _aupdate_existing_row_data_oapg(
        self,
    ...
    def _update_existing_row_data_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateExistingRowDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_existing_row_data(
        self,
        org_id: str,
        table_id: str,
        key_column: str,
        ...
        **kwargs,
        ...
        args = self._update_existing_row_data_mapped_args(
            org_id=org_id,
            table_id=table_id,
        ...
        return await self._aupdate_existing_row_data_oapg(
            body=args.body,
    ...
    def update_existing_row_data(
        ...
        return self._update_existing_row_data_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateExistingRowData(BaseApi):
    ...
    async def aupdate_existing_row_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_existing_row_data(
            org_id=org_id,
            table_id=table_id,
            key_column=key_column,
            key_value=key_value,
    ...
    def update_existing_row_data(
        ...
        raw_response = self.raw.update_existing_row_data(
            org_id=org_id,
            table_id=table_id,
            key_column=key_column,
            key_value=key_value,
