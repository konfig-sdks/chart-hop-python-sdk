...
ApproxLimitSchema = schemas.Int32Schema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'approxLimit': typing.Union[ApproxLimitSchema, decimal.Decimal, int, ],
...
request_query_approx_limit = api_client.QueryParameter(
    name="approxLimit",
    style=api_client.ParameterStyle.FORM,
    schema=ApproxLimitSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_region_jobs_graph_mapped_args(
        self,
        org_id: str,
        start: typing.Optional[str] = None,
        depth: typing.Optional[int] = None,
        approx_limit: typing.Optional[int] = None,
        ...
        if approx_limit is not None:
            _query_params["approxLimit"] = approx_limit
    ...
    async def _aget_region_jobs_graph_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/org/{orgId}/job/graph',
            headers=_headers,
        )
    ...
    def _get_region_jobs_graph_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetRegionJobsGraphRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_region_jobs_graph(
        self,
        org_id: str,
        start: typing.Optional[str] = None,
        depth: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_region_jobs_graph_mapped_args(
            org_id=org_id,
            start=start,
            depth=depth,
        ...
        return await self._aget_region_jobs_graph_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_region_jobs_graph(
        self,
        org_id: str,
        start: typing.Optional[str] = None,
        depth: typing.Optional[int] = None,
        ...
        return self._get_region_jobs_graph_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetRegionJobsGraph(BaseApi):
    ...
    async def aget_region_jobs_graph(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_region_jobs_graph(
            org_id=org_id,
            start=start,
            depth=depth,
            approx_limit=approx_limit,
    ...
    def get_region_jobs_graph(
        ...
        raw_response = self.raw.get_region_jobs_graph(
            org_id=org_id,
            start=start,
            depth=depth,
            approx_limit=approx_limit,
