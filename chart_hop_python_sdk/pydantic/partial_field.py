...
from chart_hop_python_sdk.pydantic.partial_field_aliases import PartialFieldAliases
from chart_hop_python_sdk.pydantic.partial_field_data_fetch_types import PartialFieldDataFetchTypes
...
class PartialField(BaseModel):
    ...
    is_unique: typing.Optional[bool] = Field(None, alias='isUnique')
    ...
    data_fetch_types: typing.Optional[PartialFieldDataFetchTypes] = Field(None, alias='dataFetchTypes')

    aliases: typing.Optional[PartialFieldAliases] = Field(None, alias='aliases')
