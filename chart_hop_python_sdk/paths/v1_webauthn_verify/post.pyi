...
class BaseApi(api_client.Api):
    ...
    def _verify_physical_key_for_user_1_mapped_args(
        self,
        request_id: str,
    ...
    async def _averify_physical_key_for_user_1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/webauthn/verify',
            body=body,
            headers=_headers,
        )
    ...
    def _verify_physical_key_for_user_1_oapg(
        self,
        body: typing.Any = None,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class VerifyPhysicalKeyForUser1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def averify_physical_key_for_user_1(
        self,
        request_id: str,
        credential_response: str,
        **kwargs,
        ...
        args = self._verify_physical_key_for_user_1_mapped_args(
            request_id=request_id,
            credential_response=credential_response,
        )
        return await self._averify_physical_key_for_user_1_oapg(
            body=args.body,
            **kwargs,
        )
    
    def verify_physical_key_for_user_1(
        self,
        request_id: str,
        credential_response: str,
    ) -> typing.Union[
        ...
        return self._verify_physical_key_for_user_1_oapg(
            body=args.body,
        )

class VerifyPhysicalKeyForUser1(BaseApi):
    ...
    async def averify_physical_key_for_user_1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.averify_physical_key_for_user_1(
            request_id=request_id,
            credential_response=credential_response,
            **kwargs,
        )
    ...
    def verify_physical_key_for_user_1(
        ...
        raw_response = self.raw.verify_physical_key_for_user_1(
            request_id=request_id,
            credential_response=credential_response,
        )
