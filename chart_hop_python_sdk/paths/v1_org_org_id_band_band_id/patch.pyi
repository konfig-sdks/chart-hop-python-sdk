...
from chart_hop_python_sdk.model.update_comp_band import UpdateCompBand as UpdateCompBandSchema
from chart_hop_python_sdk.model.job_tier_field import JobTierField as JobTierFieldSchema
from chart_hop_python_sdk.model.money import Money as MoneySchema

from chart_hop_python_sdk.type.update_comp_band import UpdateCompBand
...
from chart_hop_python_sdk.pydantic.job_tier_field import JobTierField as JobTierFieldPydantic
from chart_hop_python_sdk.pydantic.update_comp_band import UpdateCompBand as UpdateCompBandPydantic
...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'bandId': typing.Union[BandIdSchema, str, ],
    }
)
...
request_path_band_id = api_client.PathParameter(
    name="bandId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=BandIdSchema,
    required=True,
...
# body param
SchemaForRequestBodyApplicationJson = UpdateCompBandSchema


request_body_update_comp_band = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_comp_band_by_id_mapped_args(
        self,
        org_id: str,
        band_id: str,
        ...
        base_interval: typing.Optional[EnumValue] = None,
        ...
        job_tier_one_field: typing.Optional[JobTierField] = None,
        job_tier_two_field: typing.Optional[JobTierField] = None,
        job_tier_three_field: typing.Optional[JobTierField] = None,
        job_level: typing.Optional[str] = None,
        ...
        if band_id is not None:
            _path_params["bandId"] = band_id
        args.query = _query_params
        args.path = _path_params
        return args

    async def _aupdate_comp_band_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/band/{bandId}',
            body=body,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_update_comp_band.serialize(body, content_type)
    ...
    def _update_comp_band_by_id_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateCompBandByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_comp_band_by_id(
        self,
        org_id: str,
        band_id: str,
        label: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_comp_band_by_id_mapped_args(
            org_id=org_id,
            band_id=band_id,
            label=label,
            color=color,
        ...
        return await self._aupdate_comp_band_by_id_oapg(
            body=args.body,
    ...
    def update_comp_band_by_id(
        ...
        return self._update_comp_band_by_id_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateCompBandById(BaseApi):
    ...
    async def aupdate_comp_band_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_comp_band_by_id(
            org_id=org_id,
            band_id=band_id,
            label=label,
            color=color,
    ...
    def update_comp_band_by_id(
        ...
        raw_response = self.raw.update_comp_band_by_id(
            org_id=org_id,
            band_id=band_id,
            label=label,
            color=color,
