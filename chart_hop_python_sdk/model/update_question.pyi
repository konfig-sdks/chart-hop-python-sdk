...
class UpdateQuestion(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["question", "fieldId", "type", "plural", "values", "options", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["question", "fieldId", "type", "plural", "values", "options", ], str]):
