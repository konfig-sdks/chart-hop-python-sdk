...
class BaseApi(api_client.Api):
    ...
    def _import_csv_data_mapped_args(
        self,
        org_id: str,
        type: str,
    ...
    async def _aimport_csv_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/org/{orgId}/group/{type}/import',
            body=body,
            headers=_headers,
        )
...
class ImportCsvDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aimport_csv_data(
        self,
        org_id: str,
        type: str,
        file: typing.Optional[typing.IO] = None,
        ...
        **kwargs,
        ...
        args = self._import_csv_data_mapped_args(
            org_id=org_id,
            type=type,
            file=file,
            date=date,
        )
        return await self._aimport_csv_data_oapg(
            body=args.body,
    ...
    def import_csv_data(
        ...
        return self._import_csv_data_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class ImportCsvData(BaseApi):
    ...
    async def aimport_csv_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aimport_csv_data(
            org_id=org_id,
            type=type,
            file=file,
            date=date,
    ...
    def import_csv_data(
        ...
        raw_response = self.raw.import_csv_data(
            org_id=org_id,
            type=type,
            file=file,
            date=date,
