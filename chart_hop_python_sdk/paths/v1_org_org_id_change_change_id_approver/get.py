...
class BaseApi(api_client.Api):
    ...
    def _check_approver_eligibility_mapped_args(
        self,
        org_id: str,
        change_id: str,
    ...
    async def _acheck_approver_eligibility_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/change/{changeId}/approver',
            headers=_headers,
        )
    ...
    def _check_approver_eligibility_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CheckApproverEligibilityRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_approver_eligibility(
        self,
        org_id: str,
        change_id: str,
        date: typing.Optional[date] = None,
        **kwargs,
        ...
        args = self._check_approver_eligibility_mapped_args(
            org_id=org_id,
            change_id=change_id,
            date=date,
        )
        return await self._acheck_approver_eligibility_oapg(
    ...
    def check_approver_eligibility(
        ...
        return self._check_approver_eligibility_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class CheckApproverEligibility(BaseApi):
    ...
    async def acheck_approver_eligibility(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_approver_eligibility(
            org_id=org_id,
            change_id=change_id,
            date=date,
            **kwargs,
    ...
    def check_approver_eligibility(
        ...
        raw_response = self.raw.check_approver_eligibility(
            org_id=org_id,
            change_id=change_id,
            date=date,
        )
