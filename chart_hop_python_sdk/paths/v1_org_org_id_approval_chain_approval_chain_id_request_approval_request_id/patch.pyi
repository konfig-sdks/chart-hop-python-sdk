...
class BaseApi(api_client.Api):
    ...
    def _update_existing_request_mapped_args(
        self,
        status: str,
        org_id: str,
    ...
    async def _aupdate_existing_request_oapg(
        self,
    ...
    def _update_existing_request_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateExistingRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_existing_request(
        self,
        status: str,
        org_id: str,
        approval_chain_id: str,
        ...
        **kwargs,
        ...
        args = self._update_existing_request_mapped_args(
            status=status,
            org_id=org_id,
        ...
        return await self._aupdate_existing_request_oapg(
            body=args.body,
    ...
    def update_existing_request(
        ...
        return self._update_existing_request_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateExistingRequest(BaseApi):
    ...
    async def aupdate_existing_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_existing_request(
            status=status,
            org_id=org_id,
            approval_chain_id=approval_chain_id,
            approval_request_id=approval_request_id,
    ...
    def update_existing_request(
        ...
        raw_response = self.raw.update_existing_request(
            status=status,
            org_id=org_id,
            approval_chain_id=approval_chain_id,
            approval_request_id=approval_request_id,
