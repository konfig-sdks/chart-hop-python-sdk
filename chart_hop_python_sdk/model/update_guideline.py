...
class UpdateGuideline(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["label", "budgetPoolId", "participantsExpr", "appliedField", "sourceField", "calculationType", "flagMode", "flagDeviationThreshold", "enablePopulateValue", "basisType", "basisExpr", "basisFieldMatrix", "fixedAmountRange", "fixedValueRange", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["flagMode"]) -> typing.Union[MetaOapg.properties.flagMode, schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["enablePopulateValue"]) -> typing.Union[MetaOapg.properties.enablePopulateValue, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["label", "budgetPoolId", "participantsExpr", "appliedField", "sourceField", "calculationType", "flagMode", "flagDeviationThreshold", "enablePopulateValue", "basisType", "basisExpr", "basisFieldMatrix", "fixedAmountRange", "fixedValueRange", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        flagMode: typing.Union[MetaOapg.properties.flagMode, str, schemas.Unset] = schemas.unset,
        ...
        enablePopulateValue: typing.Union[MetaOapg.properties.enablePopulateValue, bool, schemas.Unset] = schemas.unset,
