...
class BaseApi(api_client.Api):
    ...
    def _delete_comp_bands_on_date_mapped_args(
        self,
        org_id: str,
    ...
    async def _adelete_comp_bands_on_date_oapg(
        self,
    ...
    def _delete_comp_bands_on_date_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeleteCompBandsOnDateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_comp_bands_on_date(
        self,
        org_id: str,
        date: typing.Optional[date] = None,
        **kwargs,
        ...
        args = self._delete_comp_bands_on_date_mapped_args(
            org_id=org_id,
            date=date,
        )
        return await self._adelete_comp_bands_on_date_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def delete_comp_bands_on_date(
        self,
        org_id: str,
        date: typing.Optional[date] = None,
    ) -> typing.Union[
        ...
        return self._delete_comp_bands_on_date_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteCompBandsOnDate(BaseApi):
    ...
    async def adelete_comp_bands_on_date(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_comp_bands_on_date(
            org_id=org_id,
            date=date,
            **kwargs,
        )
    ...
    def delete_comp_bands_on_date(
        ...
        raw_response = self.raw.delete_comp_bands_on_date(
            org_id=org_id,
            date=date,
        )
        if validate:
