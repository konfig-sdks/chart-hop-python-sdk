...
class BaseApi(api_client.Api):
    ...
    def _get_oauth2_authorization_code_mapped_args(
        self,
        org_id: str,
        app_user_id: str,
    ...
    async def _aget_oauth2_authorization_code_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/app/org/{orgId}/install/{appUserId}/code',
            headers=_headers,
        )
    ...
    def _get_oauth2_authorization_code_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetOauth2AuthorizationCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_oauth2_authorization_code(
        self,
        org_id: str,
        app_user_id: str,
        scope: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_oauth2_authorization_code_mapped_args(
            org_id=org_id,
            app_user_id=app_user_id,
            scope=scope,
        )
        return await self._aget_oauth2_authorization_code_oapg(
    ...
    def get_oauth2_authorization_code(
        ...
        return self._get_oauth2_authorization_code_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetOauth2AuthorizationCode(BaseApi):
    ...
    async def aget_oauth2_authorization_code(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_oauth2_authorization_code(
            org_id=org_id,
            app_user_id=app_user_id,
            scope=scope,
            **kwargs,
    ...
    def get_oauth2_authorization_code(
        ...
        raw_response = self.raw.get_oauth2_authorization_code(
            org_id=org_id,
            app_user_id=app_user_id,
            scope=scope,
        )
