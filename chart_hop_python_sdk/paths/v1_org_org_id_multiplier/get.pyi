...
class BaseApi(api_client.Api):
    ...
    def _find_comp_band_multipliers_in_org_0_mapped_args(
        self,
        org_id: str,
    ...
    async def _afind_comp_band_multipliers_in_org_0_oapg(
        self,
    ...
    def _find_comp_band_multipliers_in_org_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class FindCompBandMultipliersInOrg0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afind_comp_band_multipliers_in_org_0(
        self,
        org_id: str,
        date: typing.Optional[date] = None,
        _from: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._find_comp_band_multipliers_in_org_0_mapped_args(
            org_id=org_id,
            date=date,
            _from=_from,
            limit=limit,
        ...
        return await self._afind_comp_band_multipliers_in_org_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def find_comp_band_multipliers_in_org_0(
        self,
        org_id: str,
        date: typing.Optional[date] = None,
        _from: typing.Optional[str] = None,
        ...
        return self._find_comp_band_multipliers_in_org_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class FindCompBandMultipliersInOrg0(BaseApi):
    ...
    async def afind_comp_band_multipliers_in_org_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afind_comp_band_multipliers_in_org_0(
            org_id=org_id,
            date=date,
            _from=_from,
            limit=limit,
    ...
    def find_comp_band_multipliers_in_org_0(
        ...
        raw_response = self.raw.find_comp_band_multipliers_in_org_0(
            org_id=org_id,
            date=date,
            _from=_from,
            limit=limit,
