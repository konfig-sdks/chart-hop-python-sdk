...
class JobLevel(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "orgId", "label", "code", "benchmarkType", "benchmarkLevel", "createId", "createAt", "updateId", "updateAt", "deleteId", "deleteAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "orgId", "label", "code", "benchmarkType", "benchmarkLevel", "createId", "createAt", "updateId", "updateAt", "deleteId", "deleteAt", ], str]):
