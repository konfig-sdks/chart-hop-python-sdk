...
class BaseApi(api_client.Api):
    ...
    def _create_new_pending_process_mapped_args(
        self,
        org_id: str,
        label: str,
        type: str,
    ...
    async def _acreate_new_pending_process_oapg(
        self,
    ...
    def _create_new_pending_process_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateNewPendingProcessRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_pending_process(
        self,
        org_id: str,
        label: str,
        type: str,
        ...
        **kwargs,
        ...
        args = self._create_new_pending_process_mapped_args(
            org_id=org_id,
            label=label,
            type=type,
            status=status,
        ...
        return await self._acreate_new_pending_process_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_new_pending_process(
        self,
        org_id: str,
        label: str,
        type: str,
        ...
        return self._create_new_pending_process_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewPendingProcess(BaseApi):
    ...
    async def acreate_new_pending_process(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_pending_process(
            org_id=org_id,
            label=label,
            type=type,
            status=status,
    ...
    def create_new_pending_process(
        ...
        raw_response = self.raw.create_new_pending_process(
            org_id=org_id,
            label=label,
            type=type,
            status=status,
