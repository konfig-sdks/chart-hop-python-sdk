...
from chart_hop_python_sdk.model.create_org_config import CreateOrgConfig as CreateOrgConfigSchema
...
from chart_hop_python_sdk.model.create_org_config_scenario_approval_chains import CreateOrgConfigScenarioApprovalChains as CreateOrgConfigScenarioApprovalChainsSchema
from chart_hop_python_sdk.model.create_org_config_required_job_fields import CreateOrgConfigRequiredJobFields as CreateOrgConfigRequiredJobFieldsSchema
from chart_hop_python_sdk.model.built_in_field_config import BuiltInFieldConfig as BuiltInFieldConfigSchema
from chart_hop_python_sdk.model.org_config import OrgConfig as OrgConfigSchema
from chart_hop_python_sdk.model.smart_currency_option import SmartCurrencyOption as SmartCurrencyOptionSchema
from chart_hop_python_sdk.model.create_org_config_hidden_field_ids import CreateOrgConfigHiddenFieldIds as CreateOrgConfigHiddenFieldIdsSchema
...
from chart_hop_python_sdk.type.create_org_config_scenario_approval_chains import CreateOrgConfigScenarioApprovalChains
from chart_hop_python_sdk.type.create_org_config import CreateOrgConfig
from chart_hop_python_sdk.type.create_org_config_required_job_fields import CreateOrgConfigRequiredJobFields
from chart_hop_python_sdk.type.create_org_config_hidden_field_ids import CreateOrgConfigHiddenFieldIds
...
from chart_hop_python_sdk.pydantic.create_org_config_required_job_fields import CreateOrgConfigRequiredJobFields as CreateOrgConfigRequiredJobFieldsPydantic
...
from chart_hop_python_sdk.pydantic.create_org_config import CreateOrgConfig as CreateOrgConfigPydantic
from chart_hop_python_sdk.pydantic.org_config import OrgConfig as OrgConfigPydantic
from chart_hop_python_sdk.pydantic.create_org_config_hidden_field_ids import CreateOrgConfigHiddenFieldIds as CreateOrgConfigHiddenFieldIdsPydantic
from chart_hop_python_sdk.pydantic.create_org_config_scenario_approval_chains import CreateOrgConfigScenarioApprovalChains as CreateOrgConfigScenarioApprovalChainsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = CreateOrgConfigSchema


request_body_create_org_config = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor201ResponseBodyApplicationJson = OrgConfigSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_if_not_exists_mapped_args(
        self,
        org_id: str,
        org_id: str,
        hidden_field_ids: typing.Optional[CreateOrgConfigHiddenFieldIds] = None,
        ...
        required_job_fields: typing.Optional[CreateOrgConfigRequiredJobFields] = None,
        scenario_approval_chains: typing.Optional[CreateOrgConfigScenarioApprovalChains] = None,
    ...
    async def _acreate_if_not_exists_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_create_org_config.serialize(body, content_type)
    ...
    def _create_if_not_exists_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateIfNotExistsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_if_not_exists(
        self,
        org_id: str,
        org_id: str,
        hidden_field_ids: typing.Optional[CreateOrgConfigHiddenFieldIds] = None,
        ...
        **kwargs,
        ...
        args = self._create_if_not_exists_mapped_args(
            org_id=org_id,
            org_id=org_id,
        ...
        return await self._acreate_if_not_exists_oapg(
            body=args.body,
    ...
    def create_if_not_exists(
        ...
        return self._create_if_not_exists_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateIfNotExists(BaseApi):
    ...
    async def acreate_if_not_exists(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_if_not_exists(
            org_id=org_id,
            org_id=org_id,
            hidden_field_ids=hidden_field_ids,
            builtin_category_map=builtin_category_map,
        ...
        if validate:
            return OrgConfigPydantic(**raw_response.body)
        return api_client.construct_model_instance(OrgConfigPydantic, raw_response.body)
    ...
    def create_if_not_exists(
        ...
        raw_response = self.raw.create_if_not_exists(
            org_id=org_id,
            org_id=org_id,
            hidden_field_ids=hidden_field_ids,
            builtin_category_map=builtin_category_map,
