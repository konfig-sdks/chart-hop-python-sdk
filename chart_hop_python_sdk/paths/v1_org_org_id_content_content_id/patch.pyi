...
class BaseApi(api_client.Api):
    ...
    def _update_piece_by_id_mapped_args(
        self,
        org_id: str,
        content_id: str,
    ...
    async def _aupdate_piece_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/content/{contentId}',
            body=body,
            headers=_headers,
        )
...
class UpdatePieceByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_piece_by_id(
        self,
        org_id: str,
        content_id: str,
        title: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_piece_by_id_mapped_args(
            org_id=org_id,
        ...
        return await self._aupdate_piece_by_id_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_piece_by_id(
        self,
        org_id: str,
        content_id: str,
        title: typing.Optional[str] = None,
        ...
        return self._update_piece_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdatePieceById(BaseApi):
    ...
    async def aupdate_piece_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_piece_by_id(
            org_id=org_id,
            content_id=content_id,
            title=title,
            parent_content_id=parent_content_id,
    ...
    def update_piece_by_id(
        ...
        raw_response = self.raw.update_piece_by_id(
            org_id=org_id,
            content_id=content_id,
            title=title,
            parent_content_id=parent_content_id,
