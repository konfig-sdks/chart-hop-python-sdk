...
class TimeOff(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "startDate", "endDate", "days", "hours", "type", "note", "approval", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "startDate", "endDate", "days", "hours", "type", "note", "approval", ], str]):
