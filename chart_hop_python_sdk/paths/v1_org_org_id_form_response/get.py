    ...
    async def _aget_by_form_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/form-response',
            headers=_headers,
        )
...
class GetByFormRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_form(
        self,
        org_id: str,
        form_id: typing.Optional[str] = None,
        assessment_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_by_form_mapped_args(
            org_id=org_id,
            form_id=form_id,
        ...
        return await self._aget_by_form_oapg(
    ...
    def get_by_form(
        ...
        return self._get_by_form_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByForm(BaseApi):
    ...
    async def aget_by_form(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_form(
            org_id=org_id,
            form_id=form_id,
            assessment_id=assessment_id,
            submit_person_id=submit_person_id,
    ...
    def get_by_form(
        ...
        raw_response = self.raw.get_by_form(
            org_id=org_id,
            form_id=form_id,
            assessment_id=assessment_id,
            submit_person_id=submit_person_id,
