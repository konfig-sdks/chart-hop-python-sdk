...
class BaseApi(api_client.Api):
    ...
    def _update_group_details_mapped_args(
        self,
        org_id: str,
        type: str,
        group_id: str,
    ...
    async def _aupdate_group_details_oapg(
        self,
    ...
    def _update_group_details_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateGroupDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_group_details(
        self,
        org_id: str,
        type: str,
        group_id: str,
        ...
        **kwargs,
        ...
        args = self._update_group_details_mapped_args(
            org_id=org_id,
            type=type,
            group_id=group_id,
        ...
        return await self._aupdate_group_details_oapg(
            body=args.body,
    ...
    def update_group_details(
        ...
        return self._update_group_details_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpdateGroupDetails(BaseApi):
    ...
    async def aupdate_group_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_group_details(
            org_id=org_id,
            type=type,
            group_id=group_id,
            scenario_id=scenario_id,
    ...
    def update_group_details(
        ...
        raw_response = self.raw.update_group_details(
            org_id=org_id,
            type=type,
            group_id=group_id,
            scenario_id=scenario_id,
