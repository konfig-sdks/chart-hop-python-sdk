...
class BaseApi(api_client.Api):
    ...
    def _delete_row_from_history_mapped_args(
        self,
        org_id: str,
        table_id: str,
        key_column: str,
    ...
    async def _adelete_row_from_history_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/table/{tableId}/data/{keyColumn}/{keyValue}/purge',
            headers=_headers,
        )
    ...
    def _delete_row_from_history_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class DeleteRowFromHistoryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_row_from_history(
        self,
        org_id: str,
        table_id: str,
        key_column: str,
        ...
        **kwargs,
        ...
        args = self._delete_row_from_history_mapped_args(
            org_id=org_id,
            table_id=table_id,
        ...
        return await self._adelete_row_from_history_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def delete_row_from_history(
        self,
        org_id: str,
        table_id: str,
        key_column: str,
        ...
        return self._delete_row_from_history_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class DeleteRowFromHistory(BaseApi):
    ...
    async def adelete_row_from_history(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_row_from_history(
            org_id=org_id,
            table_id=table_id,
            key_column=key_column,
            key_value=key_value,
    ...
    def delete_row_from_history(
        ...
        raw_response = self.raw.delete_row_from_history(
            org_id=org_id,
            table_id=table_id,
            key_column=key_column,
            key_value=key_value,
