...
class BaseApi(api_client.Api):
    ...
    def _upsert_row_data_mapped_args(
        self,
        org_id: str,
        table_id: str,
    ...
    async def _aupsert_row_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/table/{tableId}/data',
            body=body,
            headers=_headers,
        )
...
class UpsertRowDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupsert_row_data(
        self,
        org_id: str,
        table_id: str,
        date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._upsert_row_data_mapped_args(
            org_id=org_id,
            table_id=table_id,
            date=date,
            scenario_id=scenario_id,
        )
        return await self._aupsert_row_data_oapg(
            body=args.body,
    ...
    def upsert_row_data(
        ...
        return self._upsert_row_data_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class UpsertRowData(BaseApi):
    ...
    async def aupsert_row_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupsert_row_data(
            org_id=org_id,
            table_id=table_id,
            date=date,
            scenario_id=scenario_id,
    ...
    def upsert_row_data(
        ...
        raw_response = self.raw.upsert_row_data(
            org_id=org_id,
            table_id=table_id,
            date=date,
            scenario_id=scenario_id,
