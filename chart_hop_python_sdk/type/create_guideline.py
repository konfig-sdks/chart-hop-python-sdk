...
class RequiredCreateGuideline(TypedDict):
    # comp review id
    compReviewId: str
...
class OptionalCreateGuideline(TypedDict, total=False):
...
class CreateGuideline(RequiredCreateGuideline, OptionalCreateGuideline):
    pass
