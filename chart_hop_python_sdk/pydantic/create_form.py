...
class CreateForm(BaseModel):
    ...
    fields: typing.List[FormField] = Field(alias='fields')

    # ordered list of blocks being collected in this form
    blocks: typing.List[FormBlock] = Field(alias='blocks')

    # status of the form
    status: Literal["ACTIVE", "INACTIVE", "ARCHIVED"] = Field(alias='status')
