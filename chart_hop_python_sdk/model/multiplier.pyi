...
class Multiplier(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "orgId", "label", "value", "expr", "code", "category", "createId", "createAt", "updateId", "updateAt", "deleteId", "deleteAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "orgId", "label", "value", "expr", "code", "category", "createId", "createAt", "updateId", "updateAt", "deleteId", "deleteAt", ], str]):
