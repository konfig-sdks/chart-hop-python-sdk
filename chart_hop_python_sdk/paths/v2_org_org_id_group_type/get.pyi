    ...
    async def _afind_of_type_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/org/{orgId}/group/{type}',
            headers=_headers,
        )
...
class FindOfTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afind_of_type(
        self,
        org_id: str,
        type: str,
        scenario_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._find_of_type_mapped_args(
            org_id=org_id,
            type=type,
        ...
        return await self._afind_of_type_oapg(
    ...
    def find_of_type(
        ...
        return self._find_of_type_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class FindOfType(BaseApi):
    ...
    async def afind_of_type(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afind_of_type(
            org_id=org_id,
            type=type,
            scenario_id=scenario_id,
            date=date,
    ...
    def find_of_type(
        ...
        raw_response = self.raw.find_of_type(
            org_id=org_id,
            type=type,
            scenario_id=scenario_id,
            date=date,
