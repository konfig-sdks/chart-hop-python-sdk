...
class RequiredCreateOrgConfig(TypedDict):
    # parent organization id
    orgId: str

class OptionalCreateOrgConfig(TypedDict, total=False):
    hiddenFieldIds: CreateOrgConfigHiddenFieldIds
    ...
    requiredJobFields: CreateOrgConfigRequiredJobFields

    scenarioApprovalChains: CreateOrgConfigScenarioApprovalChains
...
class CreateOrgConfig(RequiredCreateOrgConfig, OptionalCreateOrgConfig):
    pass
