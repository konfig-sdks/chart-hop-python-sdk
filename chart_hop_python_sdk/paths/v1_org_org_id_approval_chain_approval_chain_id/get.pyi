...
SchemaFor200ResponseBodyApplicationJson = ApprovalChainSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_approval_chain_by_id_mapped_args(
        self,
        org_id: str,
    ...
    async def _aget_approval_chain_by_id_oapg(
        self,
    ...
    def _get_approval_chain_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetApprovalChainByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_approval_chain_by_id(
        self,
        org_id: str,
        approval_chain_id: str,
        **kwargs,
        ...
        args = self._get_approval_chain_by_id_mapped_args(
            org_id=org_id,
            approval_chain_id=approval_chain_id,
        )
        return await self._aget_approval_chain_by_id_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_approval_chain_by_id(
        self,
        org_id: str,
        approval_chain_id: str,
    ) -> typing.Union[
        ...
        return self._get_approval_chain_by_id_oapg(
            path_params=args.path,
        )

class GetApprovalChainById(BaseApi):
    ...
    async def aget_approval_chain_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_approval_chain_by_id(
            org_id=org_id,
            approval_chain_id=approval_chain_id,
            **kwargs,
        )
    ...
    def get_approval_chain_by_id(
        ...
        raw_response = self.raw.get_approval_chain_by_id(
            org_id=org_id,
            approval_chain_id=approval_chain_id,
        )
        if validate:
