...
from chart_hop_python_sdk.model.report_metrics_return_type import ReportMetricsReturnType as ReportMetricsReturnTypeSchema

from chart_hop_python_sdk.type.report_metrics_return_type import ReportMetricsReturnType

from ...api_client import Dictionary
from chart_hop_python_sdk.pydantic.report_metrics_return_type import ReportMetricsReturnType as ReportMetricsReturnTypePydantic

from . import path

# Query params
ProvidedQuerySchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'providedQuery': typing.Union[ProvidedQuerySchema, str, ],
...
request_query_provided_query = api_client.QueryParameter(
    name="providedQuery",
    style=api_client.ParameterStyle.FORM,
    schema=ProvidedQuerySchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = ReportMetricsReturnTypeSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ReportMetricsReturnType
...
class BaseApi(api_client.Api):
    ...
    def _query_underlying_data_in_chart_mapped_args(
        self,
        org_id: str,
        report_id: str,
        chart_id: str,
        provided_query: typing.Optional[str] = None,
        ...
        _query_params = {}
        _path_params = {}
        if provided_query is not None:
            _query_params["providedQuery"] = provided_query
    ...
    async def _aquery_underlying_data_in_chart_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/report/{reportId}/chart/{chartId}/query',
            headers=_headers,
        )
    ...
    def _query_underlying_data_in_chart_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class QueryUnderlyingDataInChartRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_underlying_data_in_chart(
        self,
        org_id: str,
        report_id: str,
        chart_id: str,
        ...
        **kwargs,
        ...
        args = self._query_underlying_data_in_chart_mapped_args(
            org_id=org_id,
            report_id=report_id,
            chart_id=chart_id,
        ...
        return await self._aquery_underlying_data_in_chart_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def query_underlying_data_in_chart(
        self,
        org_id: str,
        report_id: str,
        chart_id: str,
        ...
        return self._query_underlying_data_in_chart_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class QueryUnderlyingDataInChart(BaseApi):
    ...
    async def aquery_underlying_data_in_chart(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReportMetricsReturnTypePydantic:
        raw_response = await self.raw.aquery_underlying_data_in_chart(
            org_id=org_id,
            report_id=report_id,
            chart_id=chart_id,
            provided_query=provided_query,
        ...
        if validate:
            return ReportMetricsReturnTypePydantic(**raw_response.body)
        return api_client.construct_model_instance(ReportMetricsReturnTypePydantic, raw_response.body)
    ...
    def query_underlying_data_in_chart(
        ...
        raw_response = self.raw.query_underlying_data_in_chart(
            org_id=org_id,
            report_id=report_id,
            chart_id=chart_id,
            provided_query=provided_query,
