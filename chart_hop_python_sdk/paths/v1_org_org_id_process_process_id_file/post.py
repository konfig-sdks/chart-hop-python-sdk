...
class BaseApi(api_client.Api):
    ...
    def _upload_file_and_mark_complete_mapped_args(
        self,
        org_id: str,
        process_id: str,
    ...
    async def _aupload_file_and_mark_complete_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/process/{processId}/file',
            body=body,
            headers=_headers,
        )
    ...
    def _upload_file_and_mark_complete_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UploadFileAndMarkCompleteRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupload_file_and_mark_complete(
        self,
        org_id: str,
        process_id: str,
        file: typing.Optional[typing.IO] = None,
        **kwargs,
        ...
        args = self._upload_file_and_mark_complete_mapped_args(
            org_id=org_id,
            process_id=process_id,
            file=file,
        )
        return await self._aupload_file_and_mark_complete_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def upload_file_and_mark_complete(
        self,
        org_id: str,
        process_id: str,
        file: typing.Optional[typing.IO] = None,
        ...
        return self._upload_file_and_mark_complete_oapg(
            body=args.body,
            path_params=args.path,
        )

class UploadFileAndMarkComplete(BaseApi):
    ...
    async def aupload_file_and_mark_complete(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupload_file_and_mark_complete(
            org_id=org_id,
            process_id=process_id,
            file=file,
            **kwargs,
    ...
    def upload_file_and_mark_complete(
        ...
        raw_response = self.raw.upload_file_and_mark_complete(
            org_id=org_id,
            process_id=process_id,
            file=file,
        )
