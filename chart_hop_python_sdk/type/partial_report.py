...
from chart_hop_python_sdk.type.partial_report_chart_ids import PartialReportChartIds
from chart_hop_python_sdk.type.share_access import ShareAccess

class RequiredPartialReport(TypedDict):
    pass

class OptionalPartialReport(TypedDict, total=False):
    # report description
    description: str
    ...
    chartIds: PartialReportChartIds
...
class PartialReport(RequiredPartialReport, OptionalPartialReport):
    pass
