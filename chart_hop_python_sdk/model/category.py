...
class Category(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def fieldIds() -> typing.Type['CategoryFieldIds']:
                return CategoryFieldIds
        
            @staticmethod
            def nativeFields() -> typing.Type['CategoryNativeFields']:
                return CategoryNativeFields
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fieldIds"]) -> 'CategoryFieldIds': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["nativeFields"]) -> 'CategoryNativeFields': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "label", "orgId", "fieldIds", "nativeFields", "createId", "createAt", "updateId", "updateAt", "deleteId", "deleteAt", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fieldIds"]) -> typing.Union['CategoryFieldIds', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["nativeFields"]) -> typing.Union['CategoryNativeFields', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "label", "orgId", "fieldIds", "nativeFields", "createId", "createAt", "updateId", "updateAt", "deleteId", "deleteAt", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        fieldIds: typing.Union['CategoryFieldIds', schemas.Unset] = schemas.unset,
        nativeFields: typing.Union['CategoryNativeFields', schemas.Unset] = schemas.unset,
