...
class Checkout(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["nextPaymentDate", "tax", "total", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["nextPaymentDate", "tax", "total", ], str]):
