...
class BaseApi(api_client.Api):
    ...
    def _evaluate_against_job_mapped_args(
        self,
        org_id: str,
        template_id: str,
    ...
    async def _aevaluate_against_job_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/template/{templateId}/render',
            headers=_headers,
        )
    ...
    def _evaluate_against_job_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class EvaluateAgainstJobRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aevaluate_against_job(
        self,
        org_id: str,
        template_id: str,
        job_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._evaluate_against_job_mapped_args(
            org_id=org_id,
        ...
        return await self._aevaluate_against_job_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def evaluate_against_job(
        self,
        org_id: str,
        template_id: str,
        job_id: typing.Optional[str] = None,
        ...
        return self._evaluate_against_job_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class EvaluateAgainstJob(BaseApi):
    ...
    async def aevaluate_against_job(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aevaluate_against_job(
            org_id=org_id,
            template_id=template_id,
            job_id=job_id,
            scenario_id=scenario_id,
    ...
    def evaluate_against_job(
        ...
        raw_response = self.raw.evaluate_against_job(
            org_id=org_id,
            template_id=template_id,
            job_id=job_id,
            scenario_id=scenario_id,
