...
class CreateUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["orgs", "appId", "name", "email", "imagePath", "status", "options", "internalOptions", "secrets", "emailSettings", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["orgs", "appId", "name", "email", "imagePath", "status", "options", "internalOptions", "secrets", "emailSettings", ], str]):
