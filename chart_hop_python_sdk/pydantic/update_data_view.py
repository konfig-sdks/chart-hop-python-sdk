...
from chart_hop_python_sdk.pydantic.update_data_view_column_widths import UpdateDataViewColumnWidths

class UpdateDataView(BaseModel):
    # data view name
    ...
    column_widths: typing.Optional[UpdateDataViewColumnWidths] = Field(None, alias='columnWidths')
