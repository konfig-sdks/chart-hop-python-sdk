...
class BaseApi(api_client.Api):
    ...
    def _get_current_user_tasks_mapped_args(
        self,
        org_id: str,
    ...
    async def _aget_current_user_tasks_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/task/me',
            headers=_headers,
        )
    ...
    def _get_current_user_tasks_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetCurrentUserTasksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_current_user_tasks(
        self,
        org_id: str,
        assessment_id: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_current_user_tasks_mapped_args(
            org_id=org_id,
        ...
        return await self._aget_current_user_tasks_oapg(
    ...
    def get_current_user_tasks(
        ...
        return self._get_current_user_tasks_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetCurrentUserTasks(BaseApi):
    ...
    async def aget_current_user_tasks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_current_user_tasks(
            org_id=org_id,
            assessment_id=assessment_id,
            status=status,
            type=type,
    ...
    def get_current_user_tasks(
        ...
        raw_response = self.raw.get_current_user_tasks(
            org_id=org_id,
            assessment_id=assessment_id,
            status=status,
            type=type,
