...
class CreateTaskConfig(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["entityId", "type", "pastDueAction", "description", "assessmentId", "parentEntityId", "dueDate", "isSkippable", "label", "deleteId", "deleteAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["entityId", "type", "pastDueAction", "description", "assessmentId", "parentEntityId", "dueDate", "isSkippable", "label", "deleteId", "deleteAt", ], str]):
