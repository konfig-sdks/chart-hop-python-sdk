...
# Query params
ShowStateSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'showState': typing.Union[ShowStateSchema, bool, ],
    },
    total=False
)
...
request_query_show_state = api_client.QueryParameter(
    name="showState",
    style=api_client.ParameterStyle.FORM,
    schema=ShowStateSchema,
    explode=True,
)
# Path params
...
class BaseApi(api_client.Api):
    ...
    def _check_process_status_mapped_args(
        self,
        org_id: str,
        process_id: str,
        show_state: typing.Optional[bool] = None,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        _query_params = {}
        _path_params = {}
        if show_state is not None:
            _query_params["showState"] = show_state
    ...
    async def _acheck_process_status_oapg(
        self,
    ...
    def _check_process_status_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CheckProcessStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_process_status(
        self,
        org_id: str,
        process_id: str,
        show_state: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._check_process_status_mapped_args(
            org_id=org_id,
            process_id=process_id,
            show_state=show_state,
        )
        return await self._acheck_process_status_oapg(
    ...
    def check_process_status(
        ...
        return self._check_process_status_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class CheckProcessStatus(BaseApi):
    ...
    async def acheck_process_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_process_status(
            org_id=org_id,
            process_id=process_id,
            show_state=show_state,
            **kwargs,
    ...
    def check_process_status(
        ...
        raw_response = self.raw.check_process_status(
            org_id=org_id,
            process_id=process_id,
            show_state=show_state,
        )
