...
from chart_hop_python_sdk.model.position_get_by_id_response import PositionGetByIdResponse as PositionGetByIdResponseSchema

from chart_hop_python_sdk.type.position_get_by_id_response import PositionGetByIdResponse

from ...api_client import Dictionary
from chart_hop_python_sdk.pydantic.position_get_by_id_response import PositionGetByIdResponse as PositionGetByIdResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = PositionGetByIdResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: PositionGetByIdResponse
    ...
    async def _aget_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/org/{orgId}/position/{positionId}',
            headers=_headers,
        )
...
class GetById(BaseApi):
    ...
    async def aget_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> PositionGetByIdResponsePydantic:
        ...
        if validate:
            return PositionGetByIdResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(PositionGetByIdResponsePydantic, raw_response.body)
