...
class BaseApi(api_client.Api):
    ...
    def _export_chart_csv_mapped_args(
        self,
        org_id: str,
        report_id: str,
        chart_id: str,
    ...
    async def _aexport_chart_csv_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/report/{reportId}/chart/{chartId}/export/csv',
            headers=_headers,
        )
...
class ExportChartCsvRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aexport_chart_csv(
        self,
        org_id: str,
        report_id: str,
        chart_id: str,
        ...
        **kwargs,
        ...
        args = self._export_chart_csv_mapped_args(
            org_id=org_id,
            report_id=report_id,
            chart_id=chart_id,
        ...
        return await self._aexport_chart_csv_oapg(
    ...
    def export_chart_csv(
        ...
        return self._export_chart_csv_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ExportChartCsv(BaseApi):
    ...
    async def aexport_chart_csv(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aexport_chart_csv(
            org_id=org_id,
            report_id=report_id,
            chart_id=chart_id,
            start_date=start_date,
    ...
    def export_chart_csv(
        ...
        raw_response = self.raw.export_chart_csv(
            org_id=org_id,
            report_id=report_id,
            chart_id=chart_id,
            start_date=start_date,
