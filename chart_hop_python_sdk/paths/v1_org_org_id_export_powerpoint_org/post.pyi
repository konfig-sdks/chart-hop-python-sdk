...
class BaseApi(api_client.Api):
    ...
    def _org_chart_to_powerpoint_mapped_args(
        self,
        org_id: str,
    ...
    async def _aorg_chart_to_powerpoint_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/export/powerpoint/org',
            body=body,
            headers=_headers,
        )
    ...
    def _org_chart_to_powerpoint_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class OrgChartToPowerpointRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aorg_chart_to_powerpoint(
        self,
        org_id: str,
        date: typing.Optional[date] = None,
        **kwargs,
        ...
        args = self._org_chart_to_powerpoint_mapped_args(
            org_id=org_id,
            date=date,
        )
        return await self._aorg_chart_to_powerpoint_oapg(
            body=args.body,
    ...
    def org_chart_to_powerpoint(
        ...
        return self._org_chart_to_powerpoint_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class OrgChartToPowerpoint(BaseApi):
    ...
    async def aorg_chart_to_powerpoint(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aorg_chart_to_powerpoint(
            org_id=org_id,
            date=date,
            **kwargs,
        )
    ...
    def org_chart_to_powerpoint(
        ...
        raw_response = self.raw.org_chart_to_powerpoint(
            org_id=org_id,
            date=date,
        )
        if validate:
