...
class CreateApprovalChainStage(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rejectBehavior", "status", "approvalCommentRequired", "rejectionCommentRequired", "order", "groups", "inclusionExpression", "inclusionBehavior", "expandExpression", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["rejectBehavior", "status", "approvalCommentRequired", "rejectionCommentRequired", "order", "groups", "inclusionExpression", "inclusionBehavior", "expandExpression", ], str]):
