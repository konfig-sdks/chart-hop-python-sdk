...
class CreateProfileTab(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["label", "blocks", "status", "sort", "targetFilter", "readFilter", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["label", "blocks", "status", "sort", "targetFilter", "readFilter", ], str]):
