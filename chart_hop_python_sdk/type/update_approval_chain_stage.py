...
class RequiredUpdateApprovalChainStage(TypedDict):
    pass

class OptionalUpdateApprovalChainStage(TypedDict, total=False):
...
class UpdateApprovalChainStage(RequiredUpdateApprovalChainStage, OptionalUpdateApprovalChainStage):
    pass
