...
class RequiredCreateQuestion(TypedDict):
    # text of the question
    question: str

class OptionalCreateQuestion(TypedDict, total=False):
...
class CreateQuestion(RequiredCreateQuestion, OptionalCreateQuestion):
    pass
