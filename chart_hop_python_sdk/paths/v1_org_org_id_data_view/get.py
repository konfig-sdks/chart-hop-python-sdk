...
from chart_hop_python_sdk.model.results_data_view import ResultsDataView as ResultsDataViewSchema

from chart_hop_python_sdk.type.results_data_view import ResultsDataView

from ...api_client import Dictionary
from chart_hop_python_sdk.pydantic.results_data_view import ResultsDataView as ResultsDataViewPydantic
...
SchemaFor200ResponseBodyApplicationJson = ResultsDataViewSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ResultsDataView
...
class GetAllPaginated(BaseApi):
    ...
    async def aget_all_paginated(
        ...
        **kwargs,
        ...
        if validate:
            return ResultsDataViewPydantic(**raw_response.body)
        return api_client.construct_model_instance(ResultsDataViewPydantic, raw_response.body)
