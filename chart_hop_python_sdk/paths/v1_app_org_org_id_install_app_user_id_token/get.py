...
class BaseApi(api_client.Api):
    ...
    def _get_token_for_app_mapped_args(
        self,
        org_id: str,
        app_user_id: str,
    ...
    async def _aget_token_for_app_oapg(
        self,
...
class GetTokenForAppRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_token_for_app(
        self,
        org_id: str,
        app_user_id: str,
        **kwargs,
        ...
        args = self._get_token_for_app_mapped_args(
            org_id=org_id,
            app_user_id=app_user_id,
        )
        return await self._aget_token_for_app_oapg(
    ...
    def get_token_for_app(
        ...
        return self._get_token_for_app_oapg(
            path_params=args.path,
        )

class GetTokenForApp(BaseApi):
    ...
    async def aget_token_for_app(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_token_for_app(
            org_id=org_id,
            app_user_id=app_user_id,
            **kwargs,
        )
    ...
    def get_token_for_app(
        ...
        raw_response = self.raw.get_token_for_app(
            org_id=org_id,
            app_user_id=app_user_id,
        )
        if validate:
