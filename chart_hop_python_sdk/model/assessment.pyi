...
class Assessment(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "orgId", "label", "slug", "type", "fields", "shareAccess", "sensitive", "color", "startDate", "endDate", "status", "doneAt", "taskCount", "taskDoneCount", "peopleIncludedCount", "query", "createId", "createAt", "updateId", "updateAt", "deleteId", "deleteAt", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "orgId", "label", "slug", "type", "fields", "shareAccess", "sensitive", "color", "startDate", "endDate", "status", "doneAt", "taskCount", "taskDoneCount", "peopleIncludedCount", "query", "createId", "createAt", "updateId", "updateAt", "deleteId", "deleteAt", ], str]):
