...
class BaseApi(api_client.Api):
    ...
    def _submit_form_data_mapped_args(
        self,
        org_id: str,
        form_id: str,
    ...
    async def _asubmit_form_data_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/form/{formId}/submit',
            body=body,
            headers=_headers,
        )
...
class SubmitFormDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asubmit_form_data(
        self,
        org_id: str,
        form_id: str,
        target_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._submit_form_data_mapped_args(
            org_id=org_id,
            form_id=form_id,
            target_id=target_id,
            target_type=target_type,
        )
        return await self._asubmit_form_data_oapg(
            body=args.body,
    ...
    def submit_form_data(
        ...
        return self._submit_form_data_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class SubmitFormData(BaseApi):
    ...
    async def asubmit_form_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asubmit_form_data(
            org_id=org_id,
            form_id=form_id,
            target_id=target_id,
            target_type=target_type,
    ...
    def submit_form_data(
        ...
        raw_response = self.raw.submit_form_data(
            org_id=org_id,
            form_id=form_id,
            target_id=target_id,
            target_type=target_type,
