...
class BaseApi(api_client.Api):
    ...
    def _get_all_for_org_mapped_args(
        self,
        org_id: str,
    ...
    async def _aget_all_for_org_oapg(
        self,
...
class GetAllForOrgRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_for_org(
        self,
        org_id: str,
        comp_review_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_all_for_org_mapped_args(
            org_id=org_id,
            comp_review_id=comp_review_id,
        )
        return await self._aget_all_for_org_oapg(
    ...
    def get_all_for_org(
        ...
        return self._get_all_for_org_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllForOrg(BaseApi):
    ...
    async def aget_all_for_org(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_for_org(
            org_id=org_id,
            comp_review_id=comp_review_id,
            **kwargs,
        )
    ...
    def get_all_for_org(
        ...
        raw_response = self.raw.get_all_for_org(
            org_id=org_id,
            comp_review_id=comp_review_id,
        )
        if validate:
