...
class UpdateFormResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["shareAccess", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["shareAccess", ], str]):
