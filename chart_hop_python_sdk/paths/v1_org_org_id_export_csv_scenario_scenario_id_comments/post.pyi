...
class BaseApi(api_client.Api):
    ...
    def _csv_scenario_comments_mapped_args(
        self,
        org_id: str,
        scenario_id: str,
    ...
    async def _acsv_scenario_comments_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/export/csv/scenario/{scenarioId}/comments',
            headers=_headers,
        )
    ...
    def _csv_scenario_comments_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CsvScenarioCommentsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acsv_scenario_comments(
        self,
        org_id: str,
        scenario_id: str,
        **kwargs,
        ...
        args = self._csv_scenario_comments_mapped_args(
            org_id=org_id,
            scenario_id=scenario_id,
        )
        return await self._acsv_scenario_comments_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def csv_scenario_comments(
        self,
        org_id: str,
        scenario_id: str,
    ) -> typing.Union[
        ...
        return self._csv_scenario_comments_oapg(
            path_params=args.path,
        )

class CsvScenarioComments(BaseApi):
    ...
    async def acsv_scenario_comments(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acsv_scenario_comments(
            org_id=org_id,
            scenario_id=scenario_id,
            **kwargs,
        )
    ...
    def csv_scenario_comments(
        ...
        raw_response = self.raw.csv_scenario_comments(
            org_id=org_id,
            scenario_id=scenario_id,
        )
        if validate:
