...
class RequiredUpdateCustomer(TypedDict):
    pass

class OptionalUpdateCustomer(TypedDict, total=False):
    # name of customer
    name: str
...
class UpdateCustomer(RequiredUpdateCustomer, OptionalUpdateCustomer):
    pass
