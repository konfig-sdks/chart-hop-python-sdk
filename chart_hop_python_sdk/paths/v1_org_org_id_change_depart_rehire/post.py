...
class BaseApi(api_client.Api):
    ...
    def _create_depart_rehire_pair_mapped_args(
        self,
        org_id: str,
    ...
    async def _acreate_depart_rehire_pair_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/change/depart-rehire',
            body=body,
            headers=_headers,
        )
    ...
    def _create_depart_rehire_pair_oapg(
        self,
        body: typing.Any = None,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CreateDepartRehirePairRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_depart_rehire_pair(
        self,
        org_id: str,
        job_id: typing.Optional[str] = None,
        org_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_depart_rehire_pair_mapped_args(
            org_id=org_id,
            job_id=job_id,
            org_id=org_id,
        ...
        return await self._acreate_depart_rehire_pair_oapg(
            body=args.body,
    ...
    def create_depart_rehire_pair(
        ...
        return self._create_depart_rehire_pair_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CreateDepartRehirePair(BaseApi):
    ...
    async def acreate_depart_rehire_pair(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_depart_rehire_pair(
            org_id=org_id,
            job_id=job_id,
            org_id=org_id,
            scenario_id=scenario_id,
    ...
    def create_depart_rehire_pair(
        ...
        raw_response = self.raw.create_depart_rehire_pair(
            org_id=org_id,
            job_id=job_id,
            org_id=org_id,
            scenario_id=scenario_id,
