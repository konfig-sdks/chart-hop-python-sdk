...
class CreateCustomer(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "email", "startDate", "billAddress", "industry", "source", "status", "salesforceAccountId", "products", "endDate", "nextInvoiceDate", "primaryHeadCountFilter", "secondaryHeadCountFilter", "arr", "projectedArr", "trialStartDate", "trialEndDate", "stripeSubscriptionSync", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "email", "startDate", "billAddress", "industry", "source", "status", "salesforceAccountId", "products", "endDate", "nextInvoiceDate", "primaryHeadCountFilter", "secondaryHeadCountFilter", "arr", "projectedArr", "trialStartDate", "trialEndDate", "stripeSubscriptionSync", ], str]):
