...
class BaseApi(api_client.Api):
    ...
    def _find_installed_app_users_0_mapped_args(
        self,
        org_id: str,
    ...
    async def _afind_installed_app_users_0_oapg(
        self,
    ...
    def _find_installed_app_users_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class FindInstalledAppUsers0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afind_installed_app_users_0(
        self,
        org_id: str,
        type: typing.Optional[str] = None,
        tags: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._find_installed_app_users_0_mapped_args(
            org_id=org_id,
            type=type,
            tags=tags,
            statuses=statuses,
        ...
        return await self._afind_installed_app_users_0_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def find_installed_app_users_0(
        self,
        org_id: str,
        type: typing.Optional[str] = None,
        tags: typing.Optional[str] = None,
        ...
        return self._find_installed_app_users_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class FindInstalledAppUsers0(BaseApi):
    ...
    async def afind_installed_app_users_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afind_installed_app_users_0(
            org_id=org_id,
            type=type,
            tags=tags,
            statuses=statuses,
    ...
    def find_installed_app_users_0(
        ...
        raw_response = self.raw.find_installed_app_users_0(
            org_id=org_id,
            type=type,
            tags=tags,
            statuses=statuses,
