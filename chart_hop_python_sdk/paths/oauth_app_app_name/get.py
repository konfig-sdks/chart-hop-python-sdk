...
class BaseApi(api_client.Api):
    ...
    def _process_oauth_redirect_request_mapped_args(
        self,
        app_name: str,
    ...
    async def _aprocess_oauth_redirect_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/oauth/app/{appName}',
            headers=_headers,
        )
    ...
    def _process_oauth_redirect_request_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
            cookie_params: typing.Optional[dict] = {},
...
class ProcessOauthRedirectRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aprocess_oauth_redirect_request(
        self,
        app_name: str,
        token: typing.Optional[str] = None,
        state: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._process_oauth_redirect_request_mapped_args(
            app_name=app_name,
            token=token,
            state=state,
            code=code,
        )
        return await self._aprocess_oauth_redirect_request_oapg(
    ...
    def process_oauth_redirect_request(
        self,
        app_name: str,
        token: typing.Optional[str] = None,
        state: typing.Optional[str] = None,
        ...
        return self._process_oauth_redirect_request_oapg(
            query_params=args.query,
            path_params=args.path,
            cookie_params=args.cookie,
        )

class ProcessOauthRedirectRequest(BaseApi):
    ...
    async def aprocess_oauth_redirect_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aprocess_oauth_redirect_request(
            app_name=app_name,
            token=token,
            state=state,
            code=code,
    ...
    def process_oauth_redirect_request(
        ...
        raw_response = self.raw.process_oauth_redirect_request(
            app_name=app_name,
            token=token,
            state=state,
            code=code,
