...
class BaseApi(api_client.Api):
    ...
    def _update_field_dry_run_mapped_args(
        self,
        org_id: str,
        field_id: str,
    ...
    async def _aupdate_field_dry_run_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/field/{fieldId}/dryrun',
            body=body,
            headers=_headers,
        )
    ...
    def _update_field_dry_run_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateFieldDryRunRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_field_dry_run(
        self,
        org_id: str,
        field_id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_field_dry_run_mapped_args(
            org_id=org_id,
            field_id=field_id,
        ...
        return await self._aupdate_field_dry_run_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_field_dry_run(
        self,
        org_id: str,
        field_id: str,
        description: typing.Optional[str] = None,
        ...
        return self._update_field_dry_run_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFieldDryRun(BaseApi):
    ...
    async def aupdate_field_dry_run(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_field_dry_run(
            org_id=org_id,
            field_id=field_id,
            description=description,
            name=name,
    ...
    def update_field_dry_run(
        ...
        raw_response = self.raw.update_field_dry_run(
            org_id=org_id,
            field_id=field_id,
            description=description,
            name=name,
