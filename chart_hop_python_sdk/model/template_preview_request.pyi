...
class TemplatePreviewRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["content", "stylesheet", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["content", "stylesheet", ], str]):
