...
class Person(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def fields() -> typing.Type['PersonFields']:
                return PersonFields
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fields"]) -> 'PersonFields': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "orgId", "userId", "contacts", "address", "remoteWorkAddress", "birthDate", "startDate", "endDate", "imagePath", "nameAudioPath", "gender", "ethnicity", "fields", "sensitiveFields", "sort", "createId", "createAt", "updateId", "updateAt", "inviteOptions", "state", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fields"]) -> typing.Union['PersonFields', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "orgId", "userId", "contacts", "address", "remoteWorkAddress", "birthDate", "startDate", "endDate", "imagePath", "nameAudioPath", "gender", "ethnicity", "fields", "sensitiveFields", "sort", "createId", "createAt", "updateId", "updateAt", "inviteOptions", "state", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        fields: typing.Union['PersonFields', schemas.Unset] = schemas.unset,
