...
class BaseApi(api_client.Api):
    ...
    def _get_category_sort_order_mapped_args(
        self,
        org_id: str,
    ...
    async def _aget_category_sort_order_oapg(
        self,
    ...
    def _get_category_sort_order_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetCategorySortOrderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_category_sort_order(
        self,
        org_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_category_sort_order_mapped_args(
            org_id=org_id,
        )
        return await self._aget_category_sort_order_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_category_sort_order(
        self,
        org_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_category_sort_order_oapg(
            path_params=args.path,
        )

class GetCategorySortOrder(BaseApi):
    ...
    async def aget_category_sort_order(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_category_sort_order(
            org_id=org_id,
            **kwargs,
        )
        if validate:
    ...
    def get_category_sort_order(
        ...
        raw_response = self.raw.get_category_sort_order(
            org_id=org_id,
        )
        if validate:
            return CategorySortPydantic(**raw_response.body)
