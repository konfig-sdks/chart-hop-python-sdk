...
class GetAllRowsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_rows(
        self,
        org_id: str,
        table_id: str,
        date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._get_all_rows_mapped_args(
            org_id=org_id,
            table_id=table_id,
            date=date,
        ...
        return await self._aget_all_rows_oapg(
    ...
    def get_all_rows(
        ...
        return self._get_all_rows_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetAllRows(BaseApi):
    ...
    async def aget_all_rows(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_rows(
            org_id=org_id,
            table_id=table_id,
            date=date,
            scenario_id=scenario_id,
    ...
    def get_all_rows(
        ...
        raw_response = self.raw.get_all_rows(
            org_id=org_id,
            table_id=table_id,
            date=date,
            scenario_id=scenario_id,
