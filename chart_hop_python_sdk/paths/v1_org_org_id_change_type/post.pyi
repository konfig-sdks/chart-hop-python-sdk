...
class BaseApi(api_client.Api):
    ...
    def _create_new_change_mapped_args(
        self,
        org_id: str,
        type: str,
    ...
    async def _acreate_new_change_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/change/{type}',
            body=body,
            headers=_headers,
        )
...
class CreateNewChangeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_change(
        self,
        org_id: str,
        type: str,
        job_id: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_change_mapped_args(
            org_id=org_id,
            type=type,
            job_id=job_id,
            org_id=org_id,
        ...
        return await self._acreate_new_change_oapg(
            body=args.body,
    ...
    def create_new_change(
        ...
        return self._create_new_change_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CreateNewChange(BaseApi):
    ...
    async def acreate_new_change(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_change(
            org_id=org_id,
            type=type,
            job_id=job_id,
            org_id=org_id,
    ...
    def create_new_change(
        ...
        raw_response = self.raw.create_new_change(
            org_id=org_id,
            type=type,
            job_id=job_id,
            org_id=org_id,
