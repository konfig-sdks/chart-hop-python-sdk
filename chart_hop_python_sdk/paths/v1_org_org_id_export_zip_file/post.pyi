...
class BaseApi(api_client.Api):
    ...
    def _file_zip_download_mapped_args(
        self,
        org_id: str,
    ...
    async def _afile_zip_download_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/export/zip/file',
            headers=_headers,
        )
...
class FileZipDownloadRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afile_zip_download(
        self,
        org_id: str,
        field: typing.Optional[str] = None,
        date: typing.Optional[date] = None,
        ...
        **kwargs,
        ...
        args = self._file_zip_download_mapped_args(
            org_id=org_id,
            field=field,
            date=date,
        ...
        return await self._afile_zip_download_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def file_zip_download(
        self,
        org_id: str,
        field: typing.Optional[str] = None,
        date: typing.Optional[date] = None,
        ...
        return self._file_zip_download_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class FileZipDownload(BaseApi):
    ...
    async def afile_zip_download(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afile_zip_download(
            org_id=org_id,
            field=field,
            date=date,
            scenario_id=scenario_id,
    ...
    def file_zip_download(
        ...
        raw_response = self.raw.file_zip_download(
            org_id=org_id,
            field=field,
            date=date,
            scenario_id=scenario_id,
