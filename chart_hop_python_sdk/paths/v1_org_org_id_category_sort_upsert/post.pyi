...
class BaseApi(api_client.Api):
    ...
    def _create_or_update_sort_order_mapped_args(
        self,
        org_id: str,
    ...
    async def _acreate_or_update_sort_order_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/category-sort/upsert',
            body=body,
            headers=_headers,
        )
    ...
    def _create_or_update_sort_order_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CreateOrUpdateSortOrderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_or_update_sort_order(
        self,
        org_id: str,
        category_ids: typing.Optional[UpdateCategorySortCategoryIds] = None,
        **kwargs,
        ...
        args = self._create_or_update_sort_order_mapped_args(
            org_id=org_id,
            category_ids=category_ids,
        )
        return await self._acreate_or_update_sort_order_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def create_or_update_sort_order(
        self,
        org_id: str,
        category_ids: typing.Optional[UpdateCategorySortCategoryIds] = None,
    ) -> typing.Union[
        ...
        return self._create_or_update_sort_order_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateOrUpdateSortOrder(BaseApi):
    ...
    async def acreate_or_update_sort_order(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_or_update_sort_order(
            org_id=org_id,
            category_ids=category_ids,
            **kwargs,
        )
    ...
    def create_or_update_sort_order(
        ...
        raw_response = self.raw.create_or_update_sort_order(
            org_id=org_id,
            category_ids=category_ids,
        )
        if validate:
