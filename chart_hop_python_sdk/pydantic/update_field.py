...
from chart_hop_python_sdk.pydantic.update_field_aliases import UpdateFieldAliases
from chart_hop_python_sdk.pydantic.update_field_data_fetch_types import UpdateFieldDataFetchTypes
...
class UpdateField(BaseModel):
    ...
    data_fetch_types: typing.Optional[UpdateFieldDataFetchTypes] = Field(None, alias='dataFetchTypes')

    aliases: typing.Optional[UpdateFieldAliases] = Field(None, alias='aliases')
