...
from chart_hop_python_sdk.pydantic.category_sort_category_ids import CategorySortCategoryIds
...
class CategorySort(BaseModel):
    ...
    category_ids: typing.Optional[CategorySortCategoryIds] = Field(None, alias='categoryIds')
