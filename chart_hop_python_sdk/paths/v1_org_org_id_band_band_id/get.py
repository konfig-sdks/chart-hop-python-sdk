...
class BaseApi(api_client.Api):
    ...
    def _find_comp_bands_in_org_mapped_args(
        self,
        org_id: str,
        band_id: str,
    ...
    async def _afind_comp_bands_in_org_oapg(
        self,
    ...
    def _find_comp_bands_in_org_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class FindCompBandsInOrgRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afind_comp_bands_in_org(
        self,
        org_id: str,
        band_id: str,
        date: typing.Optional[date] = None,
        **kwargs,
        ...
        args = self._find_comp_bands_in_org_mapped_args(
            org_id=org_id,
            band_id=band_id,
            date=date,
        )
        return await self._afind_comp_bands_in_org_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def find_comp_bands_in_org(
        self,
        org_id: str,
        band_id: str,
        date: typing.Optional[date] = None,
        ...
        return self._find_comp_bands_in_org_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class FindCompBandsInOrg(BaseApi):
    ...
    async def afind_comp_bands_in_org(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afind_comp_bands_in_org(
            org_id=org_id,
            band_id=band_id,
            date=date,
            **kwargs,
    ...
    def find_comp_bands_in_org(
        ...
        raw_response = self.raw.find_comp_bands_in_org(
            org_id=org_id,
            band_id=band_id,
            date=date,
        )
