...
class BaseApi(api_client.Api):
    ...
    def _create_new_position_mapped_args(
        self,
        org_id: str,
    ...
    async def _acreate_new_position_oapg(
        self,
...
class CreateNewPositionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_position(
        self,
        org_id: str,
        scenario_id: typing.Optional[str] = None,
        date: typing.Optional[date] = None,
        **kwargs,
        ...
        args = self._create_new_position_mapped_args(
            org_id=org_id,
            scenario_id=scenario_id,
            date=date,
        )
        return await self._acreate_new_position_oapg(
            body=args.body,
    ...
    def create_new_position(
        ...
        return self._create_new_position_oapg(
            body=args.body,
            query_params=args.query,
            path_params=args.path,
        )

class CreateNewPosition(BaseApi):
    ...
    async def acreate_new_position(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_position(
            org_id=org_id,
            scenario_id=scenario_id,
            date=date,
            **kwargs,
    ...
    def create_new_position(
        ...
        raw_response = self.raw.create_new_position(
            org_id=org_id,
            scenario_id=scenario_id,
            date=date,
        )
