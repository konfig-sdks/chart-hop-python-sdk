...
class BaseApi(api_client.Api):
    ...
    def _validate_timeoff_request_mapped_args(
        self,
        start_date: date,
        end_date: date,
        org_id: str,
    ...
    async def _avalidate_timeoff_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/org/{orgId}/timeoff/request/validate',
            body=body,
            headers=_headers,
        )
    ...
    def _validate_timeoff_request_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ValidateTimeoffRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def avalidate_timeoff_request(
        self,
        start_date: date,
        end_date: date,
        org_id: str,
        ...
        **kwargs,
        ...
        args = self._validate_timeoff_request_mapped_args(
        ...
        return await self._avalidate_timeoff_request_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def validate_timeoff_request(
        self,
        start_date: date,
        end_date: date,
        org_id: str,
        ...
        return self._validate_timeoff_request_oapg(
            body=args.body,
            path_params=args.path,
        )

class ValidateTimeoffRequest(BaseApi):
    ...
    async def avalidate_timeoff_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.avalidate_timeoff_request(
            start_date=start_date,
            end_date=end_date,
            org_id=org_id,
            person_id=person_id,
    ...
    def validate_timeoff_request(
        ...
        raw_response = self.raw.validate_timeoff_request(
            start_date=start_date,
            end_date=end_date,
            org_id=org_id,
            person_id=person_id,
